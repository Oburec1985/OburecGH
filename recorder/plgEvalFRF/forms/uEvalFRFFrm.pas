...
type
  ...
  public
    ...
    // усредненная Frf
    lineAvFRF, lineAvSpm: cBuffTrend1d;
...
begin
  ...
  begin
    ...
    begin
      ...
      l.dx := c.fspmdx;
      s.lineAvSpm := l;
      s.lineAvSpm.name := s.name + '_AvSpm';
      s.lineAvSpm.dx := c.fspmdx;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            // нормировка данных с учетом окон
            block.prepareData;
            block.BuildSpm;
