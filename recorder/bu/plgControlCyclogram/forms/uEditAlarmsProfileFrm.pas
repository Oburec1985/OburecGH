...
type
  ...
  TEditProfileRefFrm = class(TForm)
...
var
  EditProfileRefFrm: TEditProfileRefFrm;
...
{ TEditProfileFrm }
procedure TEditProfileRefFrm.ApplyBtnClick(Sender: TObject);
var
  p:tprofile;
  I: Integer;
begin
...
procedure TEditProfileRefFrm.UpdateBtnClick(Sender: TObject);
var
  I: Integer;
  p:tprofile;
begin
...
constructor TEditProfileRefFrm.create(aowner: tcomponent);
begin
  inherited;
  init;
end;

function TEditProfileRefFrm.editProfile(p: TProfile; profilelist:tprofilelist):TProfile;
var
  I: Integer;
begin
  plist:=profilelist;
...
procedure TEditProfileRefFrm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  ModalResult:=mrok;
end;

procedure TEditProfileRefFrm.init;
begin
...
procedure TEditProfileRefFrm.ProfileLBMouseUp(Sender: TObject;
...
procedure TEditProfileRefFrm.ProfilePointsSGEndEdititng(Sender: TObject; ACol,
...
procedure TEditProfileRefFrm.ProfilePointsSGKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  sg: TStringGridExt;
begin
...
procedure TEditProfileRefFrm.showprofilelist(plist:tstringlist);
var
  I: Integer;
  p:TProfile;
begin
...
procedure TEditProfileRefFrm.SyncProfileList(plist: tprofilelist);
var
  I, j: Integer;
  p:TProfile;
  find:boolean;
...
procedure TEditProfileRefFrm.pToSg(p: tprofile);
var
  i, row: integer;
begin
...
procedure TEditProfileRefFrm.saveToIni(dir: string);
var
  ifile:tinifile;
begin
...
procedure TEditProfileRefFrm.LoadIni(dir: string);
var
  ifile:tinifile;
begin
  ifile:=tinifile.create(dir+'EditProfileFrm.ini');
...
procedure TEditProfileRefFrm.SgToP(p: tprofile);
var
  i, row: integer;
begin
