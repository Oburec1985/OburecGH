...
procedure TPressFrm2.IntEdit1Change(Sender: TObject);
var
  I: Integer;
  f:TPressFrmFrame2;
begin
  ...
  begin
    f:=Frame(i);
    f.ProgrBar.Progress:=IntEdit1.IntNum;
  end;
end;
...
begin
  ...
  begin
    ...
    g_PressCamFactory2.m_Manualref:=a_pIni.ReadBool('PressCamFactory2', 'ManualRef',false);
