...
type
  ...
  public
    ...
    // для установки свойств из другого плагина
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ind := sg.row-1;
        // модифицируем имя только в том случае если вписано свойство
        // повторившимся именем в новую ячейку
        if ind <> -1 then
        begin
...
begin
  ...
  // добавление свойств и удаление через эвент. Нужно переделать механизм
  // в триггерах для правки бд на прямые вызовы интерфесов
  {
