...
type
  ...
  public
    ...
    // список подгруп TThresholdGroup. Ќужно например дл€ частотного профил€
    m_SubGroups:tlist;
    owner:tstringlist;
    m_lastControlVal:integer;
    initList:boolean;
    // тег дл€ переключени€ наборов
    ControlTag:ctag;
    // список TAlarms
    AlarmList:tstringlist;
    name:string;
    // данные набора прописываемые в алармы
    // номер в массиве определ€етс€ по сути номером режима с набором
    // уставок
    // не используетс€ дл€ профил€ частот!!!
  ...
  public
    ...
    // получить значение тега управл€ющего наборами
  ...
  // —оздаетс€ классом TThresholdGroup в addtag
  // m_OutRangeLevel
  TAlarms = class
  public
