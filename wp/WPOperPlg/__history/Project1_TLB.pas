...
const
  ...
  LIBID_Project1: TGUID = '{EF588BC7-1D9B-406A-9E60-FCE63C27FA95}';

  CLASS_class1: TGUID = '{74509589-E7EF-40E3-B0F5-3C37988B3F75}';
type
...
class function Coclass1.Create: IWPPlugin;
begin
  Result := CreateComObject(CLASS_class1) as IWPPlugin;
end;

class function Coclass1.CreateRemote(const MachineName: string): IWPPlugin;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_class1) as IWPPlugin;
end;
