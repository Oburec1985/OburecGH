...
// File generated on 15.08.2005 13:47:02 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\Program Files\Mera\WinPOS\WinPos.exe (1)
// LIBID: {BB9A452A-71C4-411E-BCCF-CA1D2ADCFB8C}
// LCID: 0
// Helpfile: 
// DepndLst: 
//   (1) v2.0 stdole, (D:\WINXP\System32\stdole2.tlb)
//   (2) v4.0 StdVCL, (D:\WINXP\System32\STDVCL40.DLL)
// Errors:
...
begin
  DefaultInterface.CreateSignal(type_);
end;

function  TWinPOS.CreateSignalXY(xtype: SYSINT; ytype: SYSINT): IDispatch;
begin
  DefaultInterface.CreateSignalXY(xtype, ytype);
end;
...
begin
  DefaultInterface.Link(path, Name, Object_);
end;
...
begin
  DefaultInterface.SeekFile(hFile, Pos, flags);
end;
...
begin
  DefaultInterface.addmenuitem(Name, id);
end;

function  TWinPOS.treeInterface: IDispatch;
begin
  DefaultInterface.treeInterface;
end;

function  TWinPOS.MainWnd: Integer;
begin
  DefaultInterface.MainWnd;
end;
...
begin
  DefaultInterface.SaveImage(fname, comment);
end;
...
begin
  DefaultInterface.GetInterval(src, start, count);
end;
...
begin
  DefaultInterface.GetTransformerType;
end;

function  TWPSignal.GetType: Integer;
begin
  DefaultInterface.GetType;
end;
...
begin
  DefaultInterface.Parameter(index);
end;
...
begin
  DefaultInterface.At(index);
end;

function  TWPNode.GetReferenceType: Integer;
begin
  DefaultInterface.GetReferenceType;
end;
...
begin
  DefaultInterface.CreateGraph(nPage);
end;
...
begin
  DefaultInterface.CreateGraphic(hGR, hAx, hSig);
end;

function  TWPGraphs.CreateLine(hGR: Integer; hAx: Integer; hSig: Integer): Integer;
begin
  DefaultInterface.CreateLine(hGR, hAx, hSig);
end;
...
begin
  DefaultInterface.ActiveGraphPage;
end;

function  TWPGraphs.ActiveGraph(hGC: Integer): Integer;
begin
  DefaultInterface.ActiveGraph(hGC);
end;
...
begin
  DefaultInterface.getProperty(Name);
end;

function  TWPOperator.getProperySet: WideString;
begin
  DefaultInterface.getProperySet;
end;
...
begin
  DefaultInterface.SetupDlg;
end;

function  TWPOperator.getPropertyValues: WideString;
begin
  DefaultInterface.getPropertyValues;
end;
...
begin
  DefaultInterface.Link(path, Name, obj);
end;
...
begin
  DefaultInterface.GetFile(index);
end;
