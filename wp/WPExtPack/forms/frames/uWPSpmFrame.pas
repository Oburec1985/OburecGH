...
uses
  Windows, Messages, Classes, Graphics, Controls, Forms, uLocalizeForm, sysutils,
  Dialogs, StdCtrls, uWPProcServices, uCommonMath;

type
  TWPSpmFrame = class(TFrame)
    WndLabel: TLabel;
    WndCB: TComboBox;
    SpmTypeLabel: TLabel;
    SpmTypeCB: TComboBox;
...
procedure TWPSpmFrame.SetOpts(str:string);
var
  pars:tstringlist;
  i:integer;
begin
...
function TWPSpmFrame.GetOpts:string;
var
  pars:tstringlist;
  ind:integer;
  v:cString;
