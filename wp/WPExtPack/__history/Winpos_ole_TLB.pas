...
const
  ...
  DIID_IWPGraphDC: TGUID = '{8B73F83A-F09D-41BD-8ADB-C9A48722A860}';
  CLASS_WPGraphDC: TGUID = '{5C7B1D1B-5A09-4605-A8EC-7AC5D03D9E4C}';
...
const
  ...
  GROPT2_SYNC = $0000000D;
  GROPT2_XMODE = $0000000E;
...
const
  ...
  LGNOPT2_LINEHEIGHT = $00000005;

// Constants for enum FONTS
type
  FONTS = TOleEnum;
const
  FONT_GENERAL = $00000000;
  FONT_PGCAP = $00000001;
  FONT_GRCAP = $00000002;
  FONT_AXIS = $00000003;
  FONT_AXIS_SEL = $00000004;
  FONT_LGN_HEADER = $00000005;
  FONT_LGN_LINE = $00000006;
  FONT_LGN_LINESEL = $00000007;
  FONT_COMM = $00000008;
  FONT_LABEL = $00000009;
...
// *********************************************************************//
  IWPGraphs = dispinterface
    ...
    function GetGraphDC(hGraph: Integer): IDispatch; dispid 87;
    procedure SetActivePage(hPage: Integer); dispid 88;
    function IsValid(hGrItem: Integer; type_: Integer): Integer; dispid 89;
  end;
...
// *********************************************************************//
  IWPUnits = dispinterface
    ...
    function GetUnitsByMark2(const mark: WideString; nTp: LongWord): {??Largeuint}OleVariant; dispid 13;
    function GetTypeByUnits(nUn: {??Largeuint}OleVariant): LongWord; dispid 14;
    ...
    procedure GetCoefs_V(nUnSrc: {??Largeuint}OleVariant; nUnDst: {??Largeuint}OleVariant; 
                         var pK1: OleVariant; var pK0: OleVariant); dispid 22;
  end;

// *********************************************************************//
// DispIntf:  IWPGraphDC
// Flags:     (4096) Dispatchable
// GUID:      {8B73F83A-F09D-41BD-8ADB-C9A48722A860}
// *********************************************************************//
  IWPGraphDC = dispinterface
    ['{8B73F83A-F09D-41BD-8ADB-C9A48722A860}']
    procedure GetRegion(hGraph: Integer; hYAxis: Integer; type_: Integer; out pval: OleVariant); dispid 1;
    procedure SetClipRect(val: OleVariant); dispid 2;
    procedure ClearClipRect; dispid 3;
    procedure XYToScreen(hYAxis: Integer; x: Double; y: Double; out varX: OleVariant; 
                         out varY: OleVariant); dispid 4;
    procedure ScreenToXY(hYAxis: Integer; x: Integer; y: Integer; out varX: OleVariant; 
                         out varY: OleVariant); dispid 5;
    procedure GetTextSize(const text: WideString; out dx: OleVariant; out dy: OleVariant); dispid 6;
    procedure SetColor(color: Integer); dispid 7;
    procedure SetLineWidth(width: Integer); dispid 8;
    procedure SetLineStipple(factor: Integer; pattern: Integer; bEnable: Integer); dispid 9;
    procedure SetFont(fontIdx: Integer); dispid 10;
    procedure DrawLine(x1: Integer; y1: Integer; x2: Integer; y2: Integer); dispid 11;
    procedure DrawRect(x1: Integer; y1: Integer; x2: Integer; y2: Integer; bFill: Integer); dispid 12;
    procedure DrawPolygon(var_: OleVariant; count: Integer; bClose: Integer; bFill: Integer); dispid 13;
    procedure DrawText(const text: WideString; x: Integer; y: Integer; align: Integer); dispid 14;
  end;
