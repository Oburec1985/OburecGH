...
type
  ...
  public
    ...
    // вычисляем границу испытаний по самым длинным сигналам
...
begin
  ...
  if childNode = nil then
  begin
    g_logFile.addInfoMes('Не найден узел с обработкой Operators');
  end;
  if childNode <> nil then
  begin
    for i := 0 to childNode.NodeCount - 1 do
...
begin
  ...
  begin
    ...
    begin
      g_logFile.addInfoMes('Не найден сигнал расчета триггера: ' + tr.TrigName);
    end;
  end;
end;
...
//XType=5 тип оси
//YType=0 тип оси
//XUnitsId=0x0 единицы измерения
//YUnitsId=0x0 единицы измерения
