...
uses uLocalizationHelper, uMeraFile;
...
begin
  ...
  begin
    errorstr:='Не корректный path к fileу File1';
  ...
  begin
    ...
    errorstr:='Не корректный path к fileу File2';
  ...
  begin
    ...
    errorstr:='Результирующий file совпадает с fileом 1';
  ...
  begin
    FileE3.Color:=$008080FF;
    errorstr:='Результирующий file совпадает с fileом 2';
    FileE3.Hint:=errorstr;
  end
  else
  begin
