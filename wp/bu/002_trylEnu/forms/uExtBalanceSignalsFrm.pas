...
uses
  uLocalizationHelper, uWpExtPack;

{$R *.dfm}

constructor TBalanceZeroFrm.Create(AOwner: TComponent);
begin
  inherited;
  TranslateForm(Self);
end;
...
begin
  ...
  begin
    ...
    if li.Checked then
    begin
      channelslv.GetSubItemByColumnName('Имя',li,str1);
...
begin
  ...
  ChannelsLV.GetSubItemByColumnName('name', li, str);
...
begin
  ...
  // 'o="/Operators/АвтоСпектр";p="kindFunc=5, numPoints=16384, nBlocks=1, nLines=0, typeWindow=1, ofsNextBlock=16384, typeMagnitude=1, type=0, method=0, isMO=1, isCorrectFunc=0, isMonFase=0, isFill0=1, fMaxVal=0, fLog=0, fPrSpec=0, f3D=0, fSwapXZ=0, iStandart=1, fFlt=0, fQual=6, log_kind=0, log_OpZn=2e-005, log_fOpZn=0, prs_kind=1, prs_loFreq=1, prs_s2n=100, prs_fCorr=0, prs_strCorr=, prs_typeCorr=0";s1_000="/Signals/6363.mera/NI6363-{PXI1Slot18-18- 1}";i1_000=0;c1_000=1000;d1_000="/Signals/resultы/NI6363-{PXI1Slot18-18- 1}_Real#2";d2_000="/Signals/resultы/NI6363-{PXI1Slot18-18- 1}_Image#2";dp1_000=3f8f260d;dp2_000=3f8fa48d;'
  // call уведомления
...
begin
  ...
  // s1_000="/Signals/signal0436.mera/3- 1";i1_000=0;c1_000=8694000;d1_000="/Signals/resultы/signal0436.mera_СA/3- 1_СA";dp1_000=1e9a008d;
  // s1_001="/Signals/signal0436.mera/18- 1_Taho";i1_001=0;c1_001=8715600;d1_001="/Signals/resultы/signal0436.mera_СA/18- 1_Taho_СA";
  // dp1_001=1e95690d;
  // s1_002="/Signals/signal0436.mera/18- 3_Stop";i1_002=0;c1_002=8715600;d1_002="/Signals/resultы/signal0436.mera_СA/18- 3_Stop_СA";dp1_002=1e96a90d;s1_003="/Signals/signal0436.mera/18- 4_Start";i1_003=0;c1_003=8715600;d1_003="/Signals/resultы/signal0436.mera_СA/18- 4_Start_СA";dp1_003=1e98248d;'
...
begin
  ...
  begin
    ...
    begin
      ...
      ChannelsLV.SetSubItemByColumnName('name',ch.absolutepath,li)
    end;
  end;
  LVChange(ChannelsLV);
end;
