...
begin
  case TabControl.TabIndex of
    0:GetGraphOpts; // display свойства graphов
    1:GetAxisOpts; // display свойства осей
    2:GetLinesOpts; // display свойства осей;
    3:GetPageOpts; // display свойства осей;
  end;
end;
...
begin
  case TabControl.TabIndex of
    0:SetGraphOpts; // display свойства graphов
    1:SetAxisOpts; // display свойства осей
    2:SetLinesOpts;
    3:SetPagesOpts;
  end;
  wp.Refresh;
...
begin
  ...
  begin
    ...
    // устанавливаем расположение graphов
