...
constructor TEditTubeFrm.Create(AOwner: TComponent);
begin
  inherited;
  TranslateForm(Self);
end;
...
begin
  ...
  begin
    ...
    signalsLV.GetSubItemByColumnName('name трубки допуска',li,str);
    signalsLV.GetSubItemByColumnName('signal name',li,name);
...
begin
  ...
  begin
    ...
    begin
      li:=signalslv.items[i];
      signalslv.SetSubItemByColumnName('name трубки допуска', TubePath.Text, li);
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      signalsLV.SetSubItemByColumnName('signal name',slist.Strings[i],li);
      signalsLV.SetSubItemByColumnName('name трубки допуска', str, li);
    end;
    slist.Destroy;
    LVChange(signalsLV);
  end;
