...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        d.ColumnText[0]:='source = '+coperobj(d.Data).srcdir+'; result = '+coperobj(d.Data).DstDir;
      end;
    ...
    begin
      ...
      begin
        ...
        case wp.SelectedSrc.IntervalOpts of
          ...
          c_IntervalTrigs:s:='Выбор границ по triggerным signalам';
          c_IntervalCursor:s:='Выбор границ по курсору актиного окна винпос';
        end;
        srclv.SetSubItemByColumnName('setup границ',s, li);
      end;
    end;
  end;
  StatusBar1.Panels[1].Text:='';
...
begin
  ...
  begin
    ...
    OperatorsLV.SetSubItemByColumnName('operator',o.operstr,li);
...
var
  ...
  str:string;
begin
  // если не делать проверку на number выбраных глюки при удалении списка
...
begin
  ...
  begin
    ...
    d.color:=VTree1.normalcolor;
  str:='source = '+o.srcdir+'; result = '+o.DstDir;
...
begin
  ...
  srclv.SetSubItemByColumnName('path',s.name,li);
...
begin
  ...
  OpersSrc.SetSubItemByColumnName('path',select.s,li);
...
begin
  ...
  begin
    ...
    case wp.SelectedSrc.IntervalOpts of
      ...
      c_IntervalTrigs:str:='Выбор границ по triggerным signalам';
      c_IntervalCursor:str:='Выбор границ по курсору актиного окна винпос';
    end;
    srclv.SetSubItemByColumnName('setup границ',str,li);
  end;
...
begin
  ...
  begin
    ...
    if li<>nil then
    begin
      SrcLV.GetSubItemByColumnName('path',li,str);
...
begin
  ...
  begin
    ...
    begin
      ...
      srclv.SetSubItemByColumnName('setup границ',s,item);
