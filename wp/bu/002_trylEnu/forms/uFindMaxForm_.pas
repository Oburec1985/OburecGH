...
type
  ...
  private
    ...
    // присвоить signalу полосу из таблицы
...
uses
  uLocalizationHelper, uFindMaxOper, uWPExtPack;
{$R *.dfm}
...
begin
  ...
  begin
    ...
    begin
      ...
      // (например folder создана генератором)
...
begin
  ...
  begin
    ...
    begin
      showmessage('result не посчитан для signalа');
    end;
    cChart1.redraw;
  end;
  ShowLevels(sig);
...
begin
  ...
  begin
    errorstr := 'Не корректный path к fileу';
