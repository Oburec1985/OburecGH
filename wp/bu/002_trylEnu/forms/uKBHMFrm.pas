...
type
  ...
  private
    ...
    procedure savegroup;
    // display сгруппированные свойства
...
constructor TKBHMFrm.Create(AOwner: TComponent);
begin
  inherited;
  TranslateForm(Self);
end;
...
begin
  ...
  propsg.Cells[1,0]:='Обоvalue параметра';
  ...
  // при подгонке размера колонок к размеру клиента растягивать все columns
...
var
  i,r,c,
  propind,
  // стартовая string внутри группы
  startrow,
  rowcount:integer;
  g:cGroup;
  p:cPropertie;
