...
type
  ...
  private
    ...
    startT, stopT:double;
  protected
    // перезаполнить CB в соответствии с выбранным sourceом
    procedure updateSrcFrm;
    // заполнить комбобокс sourceов
    procedure FillSrcCB;
    // проверяем что выбран signal старт/стоп
...
begin
  ...
  begin
    ...
    ActiveLabel.Caption:='Не активно';
  end;
