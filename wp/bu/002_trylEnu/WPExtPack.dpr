...
begin
  ...
  ExecutableFilename := GetModuleName(HInstance);
  DefaultInstance.bindtextdomain('WPExtPack', ExtractFilePath(ExecutableFilename) + 'locale');
  DefaultInstance.textdomain('WPExtPack');
  DefaultInstance.UseLanguage('en');
end.
