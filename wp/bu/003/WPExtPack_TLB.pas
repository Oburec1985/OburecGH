...
// $Rev: 17244 $
// File generated on 27.11.2013 18:27:43 from Type Library described below.

// ************************************************************************  //
// Type Lib: E:\Oburec\delphi\2011\wp\WPExtPack\WPExtPack (1)
// LIBID: {A92E8923-3C80-4658-B25F-4BCED34D9B22}
// LCID: 0
// Helpfile:
// HelpString:
// DepndLst:
//   (1) v2.0 stdole, (D:\WINDOWS\system32\stdole2.tlb)
//   (2) v1.1 Winpos_ole, (D:\Program Files\MERA\WinPOS\WinPos.tlb)
//   (3) v1.1 Winpos_ole, (D:\Program Files\MERA\WinPOS\WinPos.tlb)
// ************************************************************************ //
...
const
  ...
  LIBID_WPExtPack: TGUID = '{A92E8923-3C80-4658-B25F-4BCED34D9B22}';
...
class function CoIEMeraPlg.Create: IWPPlugin;
begin
  Result := CreateComObject(CLASS_IEMeraPlg) as IWPPlugin;
end;

class function CoIEMeraPlg.CreateRemote(const MachineName: string): IWPPlugin;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_IEMeraPlg) as IWPPlugin;
end;
