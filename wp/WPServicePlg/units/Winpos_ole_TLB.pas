...
// $Rev: 17244 $
// File generated on 10.09.2013 12:23:51 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\WP\Debug\WinPos.exe (1)
...
// *********************************************************************//
  IWPSignal = dispinterface
    ...
    function GetSType(nTypeType: Integer; nTypeAx: Integer): Integer; dispid 59;
    procedure ConvertTime(dblSrcTime: Double; out pdblDstTime: Double; nConvType: SYSINT); dispid 56;
    ...
    procedure SetSType(nTypeType: Integer; nTypeAx: Integer; nTypeVal: Integer); dispid 58;
...
{$ENDIF}
  ...
  public
    ...
    function GetSType(nTypeType: Integer; nTypeAx: Integer): Integer;
    function ConvertTime(dblSrcTime: Double; out pdblDstTime: Double; nConvType: SYSINT): HResult;
    ...
    procedure SetSType(nTypeType: Integer; nTypeAx: Integer; nTypeVal: Integer);
...
function TWPSignal.GetSType(nTypeType: Integer; nTypeAx: Integer): Integer;
begin
  Result := DefaultInterface.GetSType(nTypeType, nTypeAx);
end;

function TWPSignal.ConvertTime(dblSrcTime: Double; out pdblDstTime: Double; nConvType: SYSINT): HResult;
begin
  DefaultInterface.ConvertTime(dblSrcTime, pdblDstTime, nConvType);
  Result := S_OK;
end;
...
procedure TWPSignal.SetSType(nTypeType: Integer; nTypeAx: Integer; nTypeVal: Integer);
begin
