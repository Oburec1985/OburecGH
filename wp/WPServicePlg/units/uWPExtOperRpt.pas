...
begin
  ...
  begin
    ...
    begin
      SetCell(1, 1+i*(blocksize+2),1, 'Режим');
    ...
    begin
      ...
      begin
        ...
        SetCell(1, (j - 1) + 3 + i * (srcList.Count - 1) * bcount +k*(bcount*srcList.Count+2), 1, src.name +#10+' Дата:'+ src.merafile.Date);
    ...
    try
      ...
      ShowMessage('Не удалось сохранить отчет. Несущесвующий каталог или файл защищен от записи');
    end;
    CloseWorkBook;
  end;
  ClearResults;
