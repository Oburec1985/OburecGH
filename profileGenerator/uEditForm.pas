...
begin
  ...
  lv.GetSubItemByColumnName('Частота',li,str);
  FreqSE.Value:=strtofloat(str);
  lv.GetSubItemByColumnName('Значение',li,str);
  ValSE.Value:=strtofloat(str);
  if showmodal=mrok then
  begin
    lv.SetSubItemByColumnName('Частота',floattostr(FreqSE.Value),li);
    lv.SetSubItemByColumnName('Значение',floattostr(ValSE.Value),li);
...
begin
  ...
  begin
    ...
    lv.GetSubItemByColumnName('Частота',last,str);
    FreqSE.Value:=strtofloatext(str);

    lv.GetSubItemByColumnName('Значение',last,str);
  ...
  begin
    ...
    lv.SetSubItemByColumnName('Частота',floattostr(FreqSE.Value),result);
    lv.SetSubItemByColumnName('Значение',floattostr(ValSE.Value),result);
