unit uPairRestore;
// Восстановить форму колеса по паре
...
// в отличие от формы венца сразу вычитается база пары
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        // получаем индекс первого импульса на корректном обороте
        sensorind:=sstruct[cursensirind].sensorind[processedturn];
        // импульс от лопатки blade
