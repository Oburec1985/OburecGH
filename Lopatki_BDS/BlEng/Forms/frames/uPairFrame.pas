...
type
  ...
  private
    pair:cpair;
  private
    // перенести список доступных ступеней в комбобокс
...
begin
  ...
  begin
    ...
    // добавляем датчики только с дружественной ступени
...
begin
  // число лопаток которое надо пропустить между датчиками пары
