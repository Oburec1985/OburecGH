...
type
  ...
  private
    ...
    // происходит когда обновляется в CommonOptsFrame список используемых датчиков
...
begin
  ...
  begin
    ...
    begin
      eng.getmessage('в списке больше 2-х датчиков',c_errorMessage);
      // выкидываем лишние датчики из списка
