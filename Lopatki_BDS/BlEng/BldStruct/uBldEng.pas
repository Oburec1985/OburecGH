...
type
  ...
  public
    ...
    // установить путь и имя файла для
...
begin
  ...
  begin
    getmessage('Попытка установить путь к каталогу воспроизведения до создания класса cFileThread',c_errorMessage);
  end;
end;
