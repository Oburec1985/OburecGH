...
uses
  ...
  uCreateObjForm in '..\..\sharedUtils\компоненты\chart_dpk\chart\forms\uCreateObjForm.pas' {TCreateObjForm: TCreateObjForm},
  ...
  uTrendSignal in '..\..\sharedUtils\компоненты\chart_dpk\chart\items\uTrendSignal.pas',
...
begin
  ...
  // ошибка загрузки формы на TLabel???????
