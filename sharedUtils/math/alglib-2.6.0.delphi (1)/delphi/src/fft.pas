...
procedure FFTR1D(const A : TReal1DArray;  N : AlglibInteger; var F : TComplex1DArray);

procedure FFTR1DInv(const F : TComplex1DArray;
     N : AlglibInteger;
     var A : TReal1DArray);

procedure FFTR1DInternalEven(var A : TReal1DArray; N : AlglibInteger; var Buf : TReal1DArray; var Plan : FTPlan);

procedure FFTR1DInvInternalEven(var A : TReal1DArray;  N : AlglibInteger; var Buf : TReal1DArray; var Plan : FTPlan);
