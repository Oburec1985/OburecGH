...
uses
  ...
  Procedure _fft(var D:TCmxArray_d; StartIndex,ALen:Integer; const TableExp:TCmxArray_d);

  Procedure FFT_recur(var D:TCmxArray_d; const TableExp:TCmxArray_d); Inline;
...
procedure _fft(var D: TCmxArray_d; StartIndex, ALen: Integer;
               const TableExp:TCmxArray_d);
var
    I,NChIndex,TableExpIndex:Integer;
    TempBn,D1:TComplex_d;
begin
...
procedure FFT_recur(var D: TCmxArray_d; const TableExp: TCmxArray_d);
begin
