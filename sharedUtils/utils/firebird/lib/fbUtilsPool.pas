...
exports
  FBPoolAddConnectionProfile,
  FBPoolAddDefaultConnectionProfile,
  FBPoolGetConnectionByProfile,
  FBPoolGetConnectionByParams,
  FBPoolGetDefaultConnection,
  FBPoolReturnConnection,
  FBPoolGetSize;
{$ENDIF}
