...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *THTMLTemplateEvent)(System::TObject* Sender, Advcardlist::TAdvCard* Card, Advcardlist::TAdvCardItem* Item, System::UnicodeString &Template);
...
typedef void __fastcall (__closure *THTMLTemplateDataEvent)(System::TObject* Sender, Advcardlist::TAdvCard* Card, Advcardlist::TAdvCardItem* Item, System::UnicodeString AFieldName, System::UnicodeString &Data);
...
protected:
	...
	System::UnicodeString __fastcall HTMLDBReplace(Advcardlist::TAdvCard* Card, Advcardlist::TAdvCardItem* Item, System::UnicodeString s, Db::TDataSet* dataset);
