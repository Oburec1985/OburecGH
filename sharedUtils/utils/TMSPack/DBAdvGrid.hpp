...
__published:
	...
	__property bool UseComboObjectValue = {read=FUseComboObjectValue, write=FUseComboObjectValue, default=0};
	...
	__property bool ReadOnly = {read=GetReadOnly, write=FReadOnly, default=0};
...
typedef void __fastcall (__closure *TGetHTMLTemplateEvent)(System::TObject* Sender, int ACol, int ARow, System::UnicodeString &HTMLTemplate, Db::TFields* Fields);
...
private:
	...
	TDBGridColumnCollection* __fastcall GetColumnCollection(void);
...
__published:
	...
	__property TDBGridColumnCollection* Columns = {read=GetColumnCollection, write=SetColumnCollection};
