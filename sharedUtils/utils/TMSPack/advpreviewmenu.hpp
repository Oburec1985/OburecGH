...
typedef void __fastcall (__closure *TMenuItemChangeEvent)(System::TObject* Sender, TAdvPreviewMenuItem* AMenuItem);

typedef void __fastcall (__closure *TSubMenuItemChangeEvent)(System::TObject* Sender, TAdvPreviewSubMenuItem* ASubMenuItem);
...
protected:
	...
	__property bool RoundedButtons = {read=FRoundedButtons, write=FRoundedButtons, nodefault};
...
private:
	...
	TMenuItemChangeEvent FOnMenuItemChange;
	TSubMenuItemChangeEvent FOnSubMenuItemChange;
...
protected:
	...
	virtual void __fastcall DoMenuItemChange(int Index);
	virtual void __fastcall DoSubMenuItemChange(TAdvPreviewSubMenuItem* SubMenuItem);
	__property bool RoundedButtons = {read=FRoundedButtons, write=FRoundedButtons, nodefault};
...
__published:
	...
	__property TMenuItemChangeEvent OnMenuItemChange = {read=FOnMenuItemChange, write=FOnMenuItemChange};
	__property TSubMenuItemClickEvent OnSubMenuItemClick = {read=FOnSubMenuItemClick, write=FOnSubMenuItemClick};
	__property TSubMenuItemChangeEvent OnSubMenuItemChange = {read=FOnSubMenuItemChange, write=FOnSubMenuItemChange};
