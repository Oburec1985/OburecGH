...
protected:
	...
	void __fastcall GetOfficeHint(const Types::TPoint &PT, Advhintinfo::TAdvHintInfo* &HintInfo);
...
public:
	...
	tagSIZE __fastcall GetHTMLSize(void);
	void __fastcall BeginUpdate(void);
	void __fastcall EndUpdate(void);
...
private:
	...
	void __fastcall SetMouseWheelDelta(const int Value);
...
protected:
	...
	virtual void __fastcall AlignControls(Controls::TControl* AControl, Types::TRect &Rect);
	void __fastcall MovePanelInt(int FromIndex, int ToIndex);
...
__published:
	...
	__property int MouseWheelDelta = {read=FMouseWheelDelta, write=SetMouseWheelDelta, nodefault};
...
#pragma option push -b-
enum TAdvPanelStyle { psXP, psFlat, psTMS, psClassic, psOffice2003Blue, psOffice2003Olive, psOffice2003Silver, psOffice2003Classic, psOffice2007Luna, psOffice2007Obsidian, psWhidbey, psWindowsXP, psCustom, psOffice2007Silver, psWindowsVista, psWindows7, psTerminal, psOffice2010Blue, psOffice2010Silver, psOffice2010Black, psWindows8, psOffice2013White, psOffice2013LightGray, psOffice2013Gray, psWindows10, psOffice2016White, psOffice2016Gray, psOffice2016Black };
#pragma option pop
...
private:
	...
	void __fastcall SetStyleAndAppColor(const TAdvPanelStyle Value, Graphics::TColor AppColor);
