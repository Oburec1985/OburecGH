...
typedef void __fastcall (__closure *TWebPostProgressEvent)(System::TObject* Sender, unsigned Position, unsigned Total);
...
private:
	...
	TWebPostProgressEvent FOnProgress;
...
protected:
	virtual void __fastcall DoProgress(unsigned Position, unsigned Total);
...
__published:
	...
	__property TWebPostProgressEvent OnProgress = {read=FOnProgress, write=FOnProgress};
};
