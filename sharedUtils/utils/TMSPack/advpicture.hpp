...
#pragma option push -b-
enum TImageFileType { itJPEG, itBMP, itPNG, itGIF, itEMF, itAll, itICO };
#pragma option pop

typedef Set<TImageFileType, itJPEG, itICO>  TImageFileTypes;

#pragma option push -b-
enum TBorderStyle { bDesign, bAlways, bEmpty, bNever };
#pragma option pop

typedef void __fastcall (__closure *TPictureSelect)(System::TObject* Sender, System::UnicodeString FileName, bool &Allow);

typedef void __fastcall (__closure *TPictureSelected)(System::TObject* Sender, System::UnicodeString FileName);
...
private:
	...
	TImageFileTypes FImageTypes;
	bool FAllowSelectOnClick;
	bool FAllowDropFiles;
	Graphics::TColor FBorderColor;
	TBorderStyle FBorderStyle;
	Graphics::TPenStyle FBorderPenStyle;
	System::UnicodeString FEmptyText;
	TPictureSelected FOnPictureSelected;
	TPictureSelect FOnPictureSelect;
	...
	void __fastcall SetBorderPenStyle(const Graphics::TPenStyle Value);
...
protected:
	...
	virtual void __fastcall DoPictureSelect(System::UnicodeString FileName, bool &Allow);
	virtual void __fastcall DoPictureSelected(System::UnicodeString FileName);
...
__published:
	__property bool AllowSelectOnClick = {read=FAllowSelectOnClick, write=FAllowSelectOnClick, default=0};
	...
	__property Graphics::TPenStyle BorderPenStyle = {read=FBorderPenStyle, write=SetBorderPenStyle, default=3};
	__property System::UnicodeString EmptyText = {read=FEmptyText, write=SetEmptyText};
	__property TImageFileTypes ImageTypes = {read=FImageTypes, write=FImageTypes, nodefault};
	...
	__property Classes::TNotifyEvent OnFrameChange = {read=FOnFrameChange, write=FOnFrameChange};
	__property TPictureSelect OnPictureSelect = {read=FOnPictureSelect, write=FOnPictureSelect};
	__property TPictureSelected OnPictureSelected = {read=FOnPictureSelected, write=FOnPictureSelected};
