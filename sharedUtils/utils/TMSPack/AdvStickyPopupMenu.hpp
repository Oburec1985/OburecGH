...
class DELPHICLASS TStickyMenuItemActionLink;
class DELPHICLASS TStickyMenuItem;
class PASCALIMPLEMENTATION TStickyMenuItemActionLink : public Actnlist::TActionLink
{
	typedef Actnlist::TActionLink inherited;
	
protected:
	TStickyMenuItem* FClient;
...
public:
	/* TBasicActionLink.Create */ inline __fastcall virtual TStickyMenuItemActionLink(System::TObject* AClient) : Actnlist::TActionLink(AClient) { }
	/* TBasicActionLink.Destroy */ inline __fastcall virtual ~TStickyMenuItemActionLink(void) { }
...
private:
	...
	TStickyMenuItemActionLink* FActionLink;
	...
	void __fastcall ActionChange(System::TObject* Sender, bool CheckDefaults);
	
protected:
	void __fastcall Click(void);
	virtual System::UnicodeString __fastcall GetDisplayName(void);
	void __fastcall InvalidatePanel(void);
	__property TStickyMenuItemActionLink* ActionLink = {read=FActionLink, write=FActionLink};
