...
private:
	...
	bool FClicksDisabled;
	int FControlIndent;
	Classes::TNotifyEvent FOnRadioButtonClick;
	int FFocusButtonIdx;
...
protected:
	...
	virtual void __fastcall DoRadioButtonClick(void);
	DYNAMIC void __fastcall DoEnter(void);
	DYNAMIC void __fastcall DoExit(void);
...
public:
	...
	__property Classes::TNotifyEvent OnRadioButtonClick = {read=FOnRadioButtonClick, write=FOnRadioButtonClick};
	__property System::UnicodeString Version = {read=GetVersion, write=SetVersion};
public:
