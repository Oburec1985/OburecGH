...
private:
	...
	bool FRounded;
	HIDESBASE void __fastcall SetTextColor(const Graphics::TColor Value);
	HIDESBASE void __fastcall SetTextColorChecked(const Graphics::TColor Value);
...
protected:
	...
	virtual void __fastcall HandleKey(System::Word Key);
...
typedef void __fastcall (__closure *TDropDownEvent)(System::TObject* Sender, bool &Allow);
...
private:
	...
	void __fastcall SetStyleEx(const TAdvSelectorStyle Value);
	...
	void __fastcall SetDropDownCheck(const bool Value);
	
protected:
	virtual void __fastcall OnToolSelect(void);
	virtual void __fastcall GetToolImage(Graphics::TBitmap* bmp);
	virtual void __fastcall GetToolPicture(Gdipicture::TGDIPPicture* &pic);
	...
	HIDESBASE virtual void __fastcall DoDropDown(void);
	virtual bool __fastcall DoCanDropDown(void);
	...
	__property TAdvSelectorStyle Style = {read=FStyle, write=SetStyleEx, nodefault};
	...
	__property bool DropDownCheck = {read=FDropDownCheck, write=SetDropDownCheck, default=0};
	__property TDropDownEvent OnCanDropDown = {read=FOnCanDropDown, write=FOnCanDropDown};
...
public:
	...
	void __fastcall BlockDropDown(const bool Value);
...
class DELPHICLASS TAdvToolSelectorActionLink;
class PASCALIMPLEMENTATION TAdvToolSelectorActionLink : public Advglowbutton::TAdvGlowButtonActionLink
{
	typedef Advglowbutton::TAdvGlowButtonActionLink inherited;
	
public:
	virtual void __fastcall UpdateSelectedIndex(int AIndex);
public:
	/* TBasicActionLink.Create */ inline __fastcall virtual TAdvToolSelectorActionLink(System::TObject* AClient) : Advglowbutton::TAdvGlowButtonActionLink(AClient) { }
	/* TBasicActionLink.Destroy */ inline __fastcall virtual ~TAdvToolSelectorActionLink(void) { }
...
public:
	__fastcall virtual TAdvOfficeToolSelector(Classes::TComponent* AOwner);
	__property Down = {default=0};
	__property bool AutoUpdateCaption = {read=FAutoUpdateCaption, write=FAutoUpdateCaption, nodefault};
...
__published:
	...
	__property DropDownCheck = {default=0};
...
class DELPHICLASS TAdvColorSelectorActionLink;
class PASCALIMPLEMENTATION TAdvColorSelectorActionLink : public Advglowbutton::TAdvGlowButtonActionLink
{
	typedef Advglowbutton::TAdvGlowButtonActionLink inherited;
	
public:
	virtual void __fastcall UpdateColor(Graphics::TColor AColor);
public:
	/* TBasicActionLink.Create */ inline __fastcall virtual TAdvColorSelectorActionLink(System::TObject* AClient) : Advglowbutton::TAdvGlowButtonActionLink(AClient) { }
	/* TBasicActionLink.Destroy */ inline __fastcall virtual ~TAdvColorSelectorActionLink(void) { }
...
private:
	...
	System::UnicodeString FCustomColors;
...
private:
	...
	HIDESBASE void __fastcall SetPicture(const Gdipicture::TGDIPPicture* Value);
