...
#pragma option push -b-
enum TFTPMode { fmBINARY, fmASCII };
#pragma option pop
...
private:
	...
	System::UnicodeString FDlgTimeSec;
	System::UnicodeString FDlgTimeMin;
	bool FCancelIsClose;
	bool FKeepAlive;
...
protected:
	...
	void __fastcall Log(System::UnicodeString s);
...
__published:
	...
	__property bool AutoURLDecode = {read=FAutoURLDecode, write=FAutoURLDecode, default=0};
	...
	__property System::UnicodeString DlgTimeSec = {read=FDlgTimeSec, write=FDlgTimeSec};
	__property System::UnicodeString DlgTimeMin = {read=FDlgTimeMin, write=FDlgTimeMin};
	__property bool FTPPassive = {read=FFTPPassive, write=FFTPPassive, nodefault};
	__property TFTPMode FTPMode = {read=FFTPMode, write=FFTPMode, default=0};
...
extern PACKAGE System::UnicodeString __fastcall FileSizeFmt(__int64 Size);
extern PACKAGE System::UnicodeString __fastcall FileSizeFmtSpeed(__int64 Size);
extern PACKAGE System::UnicodeString __fastcall TimeFmt(unsigned ticks, __int64 cursize, __int64 totsize, System::UnicodeString TS, System::UnicodeString TM);
