...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TUpdateRecordEvent)(System::TObject* Sender, System::UnicodeString &Value);
...
protected:
	...
	virtual void __fastcall DoUpdateRecord(System::UnicodeString &Value);
