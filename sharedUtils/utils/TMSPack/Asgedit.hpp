...
class PASCALIMPLEMENTATION TAsgSpeedButton : public Buttons::TSpeedButton
{
	typedef Buttons::TSpeedButton inherited;
...
public:
	__fastcall virtual TAsgSpeedButton(Classes::TComponent* AOwner);
	__fastcall virtual ~TAsgSpeedButton(void);
...
private:
	...
	System::UnicodeString __fastcall GetTextAndUnit(void);
