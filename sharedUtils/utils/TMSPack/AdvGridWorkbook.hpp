...
typedef void __fastcall (__closure *TSheetChangedEvent)(System::TObject* Sender, int NewSheet);
...
private:
	...
	TSheetChangedEvent FOnSheetChanged;
	TTabLook* FTabLook;
	bool FProgSheetChange;
...
protected:
	...
	virtual TAdvStringGridClass __fastcall GetGridClass(void);
	virtual void __fastcall DoSheetChange(int NewTab, bool &AllowChange);
	virtual void __fastcall DoSheetChanged(int NewTab);
...
__published:
	...
	__property TSheetChangedEvent OnSheetChanged = {read=FOnSheetChanged, write=FOnSheetChanged};
