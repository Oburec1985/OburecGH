...
class PASCALIMPLEMENTATION TDBLookupInspectorEditLink : public Inspectorbar::TInspectorEditLink
{
	typedef Inspectorbar::TInspectorEditLink inherited;
	
private:
	Dbctrls::TDBLookupComboBox* FEdit;
	TDBInspectorItem* FItem;
	
protected:
	void __fastcall LookupChanged(System::TObject* Sender);
	
public:
	__fastcall virtual TDBLookupInspectorEditLink(Classes::TComponent* AOwner);
	__fastcall virtual ~TDBLookupInspectorEditLink(void);
