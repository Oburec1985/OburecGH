...
private:
	...
	Planner::TItemEvent FOnItemDelete;
...
public:
	...
	bool __fastcall HasPlannerItem(System::TDateTime FromDate, System::TDateTime ToDate = 0.000000E+00);
...
__published:
	...
	__property Planner::TItemEvent OnItemDelete = {read=FOnItemDelete, write=FOnItemDelete};
