...
public:
	...
	__fastcall TGPFont(System::WideString familyName, float emSize, Graphics::TFontStyles style, Unit_ unit_, TGPFontCollection* fontCollection)/* overload */;
...
public:
	...
	Status __fastcall AddString(System::WideString string_, int length, TGPFontFamily* family, int style, float emSize, const TGPPointF &origin, TGPStringFormat* format)/* overload */;
	Status __fastcall GetBounds(/* out */ TGPRectF &bounds, TGPMatrix* matrix = (TGPMatrix*)(0x0), TGPPen* pen = (TGPPen*)(0x0))/* overload */;
	Status __fastcall GetPathPoints(PGPPointF points, int count)/* overload */;
...
public:
	...
	Status __fastcall ResetTransform(void);
	Status __fastcall MultiplyTransform(const TGPMatrix* matrix, MatrixOrder order = (MatrixOrder)(0x0));
	Status __fastcall TranslateTransform(float dx, float dy, MatrixOrder order = (MatrixOrder)(0x0));
	Status __fastcall ScaleTransform(const float sx, const float sy, MatrixOrder order = (MatrixOrder)(0x0));
	Status __fastcall RotateTransform(const float angle, MatrixOrder order = (MatrixOrder)(0x0));
	...
	Status __fastcall DrawBezier(TGPPen* pen, const TGPPointF &pt1, const TGPPointF &pt2, const TGPPointF &pt3, const TGPPointF &pt4)/* overload */;
	Status __fastcall DrawBeziers(TGPPen* pen, PGPPointF points, int count)/* overload */;
...
extern PACKAGE void __fastcall SetWin8(bool AWin8);
extern PACKAGE bool __fastcall IsWin8(void);
extern PACKAGE void __fastcall SetWin10(bool AWin10);
extern PACKAGE bool __fastcall IsWin10(void);
extern PACKAGE float __fastcall CalculateDPIScale(bool Scaled, HDC AHDC)/* overload */;
extern PACKAGE float __fastcall DPIScale(void);
extern PACKAGE float __fastcall CalculateDPIScale(Forms::TCustomForm* AForm, HDC AHDC)/* overload */;
...
extern PACKAGE TGPGraphicsPath* __fastcall CreateRoundRectangle(const Types::TRect &R, int Radius);
