...
typedef DynamicArray<bool> TBoolArray;

typedef DynamicArray<short> TWidthArray;

#pragma option push -b-
enum TAdvGridStyle { gsOffice2003Blue, gsOffice2003Silver, gsOffice2003Olive, gsOffice2003Classic, gsOffice2007Luna, gsOffice2007Obsidian, gsWindowsXP, gsWhidbey, gsCustom, gsOffice2007Silver, gsWindowsVista, gsWindows7, gsTerminal, gsOffice2010Blue, gsOffice2010Silver, gsOffice2010Black, gsWindows8, gsOffice2013white, gsOffice2013LightGray, gsOffice2013Gray, gsWindows10, gsOffice2016white, gsOffice2016Gray, gsOffice2016Black };
#pragma option pop

#pragma option push -b-
enum TFilterType { ftStartsWith, ftEndsWith, ftContains, ftNotContains, ftEqual, ftNotEqual, ftLargerThan, ftSmallerThan, ftClear, ftNone };
#pragma option pop

#pragma option push -b-
enum TSearchType { stStartsWith, stEndsWith, stContains, stEqual, stNotEqual, stNotContains };
#pragma option pop
...
typedef void __fastcall (__closure *TClipboardPasteDoneEvent)(System::TObject* Sender, const Grids::TGridRect &CellRect);
...
#pragma option push -b-
enum TRadioButtonGroup { rgNone, rgCol, rgRow };
#pragma option pop
...
typedef void __fastcall (__closure *TFilterCheckEvent)(System::TObject* Sender, int Column, int ItemIndex, System::UnicodeString FriendlyName, System::UnicodeString &FilterCondition, Checklst::TCheckListBox* CheckList);

typedef void __fastcall (__closure *TFilterCheckClickEvent)(System::TObject* Sender, int Column, int ItemIndex, bool State, Checklst::TCheckListBox* CheckList);
...
class PASCALIMPLEMENTATION TFilterEdit : public Classes::TPersistent
{
	typedef Classes::TPersistent inherited;
...
__published:
	...
	__property Classes::TStringList* TypeNames = {read=FTypeNames, write=SetTypeNames};
};
...
class PASCALIMPLEMENTATION TBaseCellGraphic : public Classes::TPersistent
{
	typedef Classes::TPersistent inherited;
...
public:
	__fastcall TBaseCellGraphic(void);
	__fastcall virtual ~TBaseCellGraphic(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
...
__published:
	...
	__property Graphics::TColor CommentColor = {read=FCommentColor, write=FCommentColor, nodefault};
public:
	/* TBaseCellGraphic.Create */ inline __fastcall TCellGraphic(void) : TBaseCellGraphic() { }
	/* TBaseCellGraphic.Destroy */ inline __fastcall virtual ~TCellGraphic(void) { }
...
#pragma option push -b-
enum THoverButtonPosition { hbLeftFromColumnLeft, hbRightFromColumnLeft, hbLeftFromColumnRight, hbRightFromColumnRight };
#pragma option pop

class DELPHICLASS THoverButtonsCollectionItem;
class PASCALIMPLEMENTATION THoverButtonsCollectionItem : public Classes::TCollectionItem
{
...
public:
	__fastcall virtual THoverButtonsCollectionItem(Classes::TCollection* Collection);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	__fastcall virtual ~THoverButtonsCollectionItem(void);
...
class PASCALIMPLEMENTATION THoverButtonsCollection : public Classes::TOwnedCollection
{
	typedef Classes::TOwnedCollection inherited;
	
public:
	THoverButtonsCollectionItem* operator[](int Index) { return Items[Index]; }
	
private:
	THoverButtonsCollectionItem* __fastcall GetItems(int Index);
	void __fastcall SetItems(int Index, const THoverButtonsCollectionItem* Value);
	
public:
	__fastcall THoverButtonsCollection(Classes::TPersistent* AOwner);
	HIDESBASE THoverButtonsCollectionItem* __fastcall Add(void);
...
public:
	/* TCollection.Destroy */ inline __fastcall virtual ~THoverButtonsCollection(void) { }
	
};


#pragma option push -b-
enum THoverRows { hrAll, hrNormal };
#pragma option pop

class DELPHICLASS THoverButtons;
class PASCALIMPLEMENTATION THoverButtons : public Classes::TPersistent
{
	typedef Classes::TPersistent inherited;
...
private:
	...
	THoverRows FRows;
	bool FMoveActiveRow;
	void __fastcall SetButtons(const THoverButtonsCollection* Value);
	
protected:
	DYNAMIC Classes::TPersistent* __fastcall GetOwner(void);
	
public:
	__fastcall THoverButtons(Classes::TPersistent* AOwner);
	__fastcall virtual ~THoverButtons(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
...
__published:
	...
	__property THoverButtonPosition Position = {read=FPosition, write=FPosition, default=3};
...
__published:
	...
	__property Advobj::TSortStyle DefaultFormat = {read=FDefaultFormat, write=FDefaultFormat, default=1};
...
public:
	TAdvStringGrid* FGrid;
	__fastcall virtual TGridControlDropDown(Classes::TComponent* AOwner);
public:
	/* TAdvControlDropDown.Destroy */ inline __fastcall virtual ~TGridControlDropDown(void) { }
...
public:
	TFilterData* operator[](int Index) { return Items[Index]; }
...
private:
	...
	Classes::TNotifyEvent FOnMatchCaseClick;
	Graphics::TColor FColorTo;
...
__published:
	...
	__property Classes::TNotifyEvent OnMatchCaseClick = {read=FOnMatchCaseClick, write=FOnMatchCaseClick};
...
class PASCALIMPLEMENTATION TColorSetting : public Classes::TPersistent
{
	typedef Classes::TPersistent inherited;
...
private:
	...
	void __fastcall SetBkgColor(const Graphics::TColor Value);
...
public:
	__fastcall TColorSetting(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	
__published:
	__property Graphics::TColor TextColor = {read=FTextColor, write=SetTextColor, default=536870911};
	__property Graphics::TColor BkgColor = {read=FBkgColor, write=SetBkgColor, default=536870911};
	__property Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TColorSetting(void) { }
	
};


class DELPHICLASS TAutoColor;
class PASCALIMPLEMENTATION TAutoColor : public Classes::TPersistent
{
	typedef Classes::TPersistent inherited;
...
private:
	...
	Classes::TNotifyEvent FOnChange;
	void __fastcall SetNegativeNumber(const TColorSetting* Value);
	void __fastcall SetPositiveNumber(const TColorSetting* Value);
	
protected:
	void __fastcall ValueChanged(System::TObject* Sender);
	virtual void __fastcall Changed(void);
	bool __fastcall ColorsDefined(void);
	
public:
	__fastcall TAutoColor(void);
	__fastcall virtual ~TAutoColor(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
...
#pragma option push -b-
enum TFormatType { ftVCL, ftExcel };
#pragma option pop

#pragma option push -b-
enum TScrollPosition { spMiddle, spTrailing, spLeading };
#pragma option pop
...
#pragma option push -b-
enum TColumnType { ctNumeric, ctFloat, ctAlpha, ctDate, ctTime, ctBoolean };
#pragma option pop

class DELPHICLASS TAdvGridPopup;
class PASCALIMPLEMENTATION TAdvGridPopup : public Classes::TComponent
{
	typedef Classes::TComponent inherited;
	
private:
	TAdvStringGrid* FGrid;
	Grids::TGridCoord FGridCell;
	bool FVisible;
	
protected:
	__property TAdvStringGrid* Grid = {read=FGrid, write=FGrid};
	__property Grids::TGridCoord GridCell = {read=FGridCell, write=FGridCell};
	
public:
	virtual void __fastcall Show(const Types::TPoint &PT);
	virtual void __fastcall Hide(void);
	virtual bool __fastcall MouseInPopup(const Types::TPoint &PT) = 0 ;
	__property bool Visible = {read=FVisible, nodefault};
public:
	/* TComponent.Create */ inline __fastcall virtual TAdvGridPopup(Classes::TComponent* AOwner) : Classes::TComponent(AOwner) { }
	/* TComponent.Destroy */ inline __fastcall virtual ~TAdvGridPopup(void) { }
	
};


#pragma option push -b-
enum TPopupToolBarMode { tbActiveCell, tbHoverCell, tbHoverNormalCell, tbNone };
#pragma option pop

__interface ITMSCellValidate;
...
private:
	typedef DynamicArray<int> _TAdvStringGrid__1;
	
	typedef DynamicArray<int> _TAdvStringGrid__2;
	
	typedef DynamicArray<System::UnicodeString> _TAdvStringGrid__3;
	
	typedef DynamicArray<int> _TAdvStringGrid__4;
	
	typedef DynamicArray<bool> _TAdvStringGrid__5;
...
private:
	...
	Classes::TNotifyEvent FOnPrintDone;
	...
	bool FSpinUpClick;
	bool FSpinDnClick;
	Grids::TGridRect FOrigSelection;
	...
	Controls::TImageList* FFltrList;
	Menus::TPopupMenu* FFltrPopup;
	...
	bool FInWMSize;
	Classes::TNotifyEvent FOnIntelliZoom;
	bool FIsNarrowDown;
	...
	Grids::TGridCoord FToolBarPopupCell;
	...
	Types::TPoint __fastcall NextVisitableCell(int ACol, int ARow);
	int __fastcall NextCol(int ACol);
	...
	int __fastcall BuildPages(Graphics::TCanvas* ACanvas, TPrintMethod PrintMethod, int MaxPages, bool SelRows);
	...
	System::UnicodeString __fastcall CopyFuncStr(const Grids::TGridRect &gd, bool DoDisjunct);
	...
	void __fastcall CalcTextPos(Types::TRect &ARect, tagSIZE &sz, int AAngle, System::UnicodeString ATxt, Classes::TAlignment hal, Advobj::TVAlignment val);
	...
	void __fastcall SetFilterEdit(const TFilterEdit* Value);
	void __fastcall SetAutoColor(const TAutoColor* Value);
	void __fastcall SetSizeWithForm(const bool Value);
	TFooterPanel* __fastcall GetFooterPanel(void);
	void __fastcall SetFormatType(const TFormatType Value);
	void __fastcall SetHoverButtons(const THoverButtons* Value);
	void __fastcall SetHTMLKeepLineBreak(const bool Value);
	void __fastcall SetCellChecker(const Asgcheck::TAdvStringGridCheck* Value);
	System::UnicodeString __fastcall GetReadCell(int i, int j);
...
protected:
	...
	virtual bool __fastcall HasColumnsProp(void);
	...
	virtual bool __fastcall CanTabToNextRow(void);
	...
	virtual bool __fastcall IsDSEdit(void);
	void __fastcall InitHiddenRowLookup(void);
	void __fastcall DestroyHiddenRowLookup(void);
	...
	virtual Types::TPoint __fastcall GetCellGraphicSizeEx(int ACol, int ARow, int Padding)/* overload */;
	virtual Types::TPoint __fastcall GetCellGraphicSizeEx(Graphics::TCanvas* ACanvas, int ACol, int ARow, int Padding, double ResFactor)/* overload */;
	...
	virtual void __fastcall DoClipboardPasteDone(const Grids::TGridRect &CellRect);
	...
	virtual TFooterPanel* __fastcall CreateFooter(void);
	...
	virtual bool __fastcall GetFilter(int ACol, bool Disp = false);
	...
	tagSIZE __fastcall GetCellTextSizeInt(int ACol, int RCol, int ARow, bool ColSize, bool VS = false, bool SB = false);
	...
	virtual void __fastcall DoIntelliZoom(void);
	...
	TGridControlDropDown* __fastcall EditControlPicker(void);
	bool __fastcall MatchesMulti(int ARow);
	Controls::TWinControl* __fastcall GetCellEditorControl(void);
	void __fastcall ClearRowSelectInt(void);
	void __fastcall GroupMerge(void);
	void __fastcall GroupSplit(void);
	void __fastcall RegisterValidateInterface(_di_ITMSCellValidate AValidate);
	void __fastcall UnregisterValidateInterface(void);
	void __fastcall ExpandFast(void);
...
public:
	...
	void __fastcall StretchColumns(void);
	...
	bool __fastcall IsSelectionHidden(void);
	...
	void __fastcall SaveToJSON(System::UnicodeString FileName, System::UnicodeString RecordDescr, Classes::TStrings* FieldDescr);
	...
	void __fastcall LoadFromCSV(System::UnicodeString FileName, Sysutils::TEncoding* AEncoding, int MaxRows = 0xffffffff)/* overload */;
	...
	System::UnicodeString __fastcall GetSelectionAsText(void);
	...
	virtual void __fastcall SetStyleAndAppColor(TAdvGridStyle AStyle, Graphics::TColor AppColor);
	...
	int __fastcall FindMulti(System::UnicodeString *Conditions, const int Conditions_Size, int *Columns, const int Columns_Size, TSearchType *Searchtypes, const int Searchtypes_Size, bool *CaseSensitive, const int CaseSensitive_Size, bool AutoGoto = false);
	int __fastcall FindMultiNext(void);
	...
	void __fastcall SetFontStyle(const Grids::TGridRect &GridRect, Graphics::TFontStyle AStyle, bool DoSet);
	bool __fastcall IsFontStyle(const Grids::TGridRect &GridRect, Graphics::TFontStyle AStyle);
	void __fastcall SetAlignment(const Grids::TGridRect &GridRect, Classes::TAlignment AAlignment);
	bool __fastcall IsAlignment(const Grids::TGridRect &GridRect, Classes::TAlignment AAlignment);
	void __fastcall SetCellColor(const Grids::TGridRect &GridRect, Graphics::TColor AColor);
	void __fastcall SetCellTextColor(const Grids::TGridRect &GridRect, Graphics::TColor AColor);
	void __fastcall SetCellFontName(const Grids::TGridRect &GridRect, System::UnicodeString AFontName);
	void __fastcall SetCellFontSize(const Grids::TGridRect &GridRect, int AFontSize);
	...
	__property Types::TPoint SearchCell = {read=FSearchCell, write=FSearchCell};
	...
	__property Controls::TWinControl* CellEditor = {read=GetCellEditorControl};
	...
	__property System::UnicodeString RealCells[int i][int j] = {read=GetReadCell, write=SetRealCell};
...
__published:
	...
	__property Classes::TNotifyEvent OnPrintDone = {read=FOnPrintDone, write=FOnPrintDone};
	...
	__property Classes::TNotifyEvent OnIntelliZoom = {read=FOnIntelliZoom, write=FOnIntelliZoom};
...
static const ShortInt MAJ_VER = 0x7;
static const ShortInt MIN_VER = 0x8;
static const ShortInt REL_VER = 0x7;
static const ShortInt BLD_VER = 0x0;
#define DATE_VER L"Nov, 2015"
extern PACKAGE System::Word CF_GRIDCELLS;
extern PACKAGE System::Word WM_GRIDEDITDONE;
extern PACKAGE System::Word WM_GRIDEDITSHOW;
extern PACKAGE System::Word WM_EDITPROP;
extern PACKAGE System::Word WM_DTPSHIFTFOCUS;
