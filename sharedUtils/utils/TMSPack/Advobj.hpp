...
#pragma option push -b-
enum TSortStyle { ssAutomatic, ssAlphabetic, ssNumeric, ssDate, ssAlphaNoCase, ssAlphaCase, ssShortDateEU, ssShortDateUS, ssCustom, ssFinancial, ssAnsiAlphaCase, ssAnsiAlphaNoCase, ssRaw, ssHTML, ssImages, ssCheckBox, ssDateTime, ssTime, ssAlphaNumeric, ssAlphaNumericNoCase, ssNatural };
#pragma option pop
...
#pragma option push -b-
enum THighlightType { hMatchingText, hFullCell };
#pragma option pop
...
#pragma option push -b-
enum THomeEndAction { heFirstLastColumn, heFirstLastRow, heFirstLastCell, heDefault };
#pragma option pop
...
#pragma option push -b-
enum TClipboardCutAction { caClear, caRemove };
#pragma option pop
...
#pragma option push -b-
enum TWheelActive { waFocus, waMouseOver };
#pragma option pop
