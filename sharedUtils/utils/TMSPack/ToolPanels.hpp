...
private:
	...
	void __fastcall SetStyleAndAppColor(const TToolPanelStyle Value, Graphics::TColor AppColor);
...
protected:
	...
	void __fastcall FitInAlignedControls(void);
...
public:
	...
	__property bool Sizing = {read=FSizing, nodefault};
...
__published:
	...
	__property Graphics::TColor ColorTo = {read=FColorTo, write=SetColorTo, default=16248798};
	...
	__property int CaptionHeight = {read=FCaptionHeight, write=SetCaptionHeight, default=23};
...
private:
	...
	void __fastcall SetLocation(const TPanelPersistLocation Value);
...
__published:
	...
	__property System::UnicodeString RegistryUserKey = {read=FRegistryKey, write=SetRegistryKey};
	__property TPanelPersistLocation Location = {read=FLocation, write=SetLocation, default=0};
	__property Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
public:
...
protected:
	...
	void __fastcall PersistenceChange(System::TObject* Sender);
	...
	void __fastcall TabFormShow(System::TObject* Sender);
	void __fastcall UpdatePanelForm(void);
...
static const ShortInt CAPTION_HEIGHT = 0x17;
