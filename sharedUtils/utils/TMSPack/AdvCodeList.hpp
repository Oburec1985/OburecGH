...
enum TItemStyle { isFixedHeight, isVariableHeight };
#pragma option pop
...
typedef void __fastcall (__closure *TBlockIndexEvent)(System::TObject* Sender, int Index);

typedef void __fastcall (__closure *TBlockAllowInsertEvent)(System::TObject* Sender, System::UnicodeString AText, bool &Allow);
...
private:
	...
	Graphics::TColor FCodeBlockCaptionSelectColor;
	Graphics::TColor FCodeBlockCaptionTextColor;
	Graphics::TColor FCodeBlockCaptionSelectTextColor;
	...
	bool FUseStyler;
	int FOldIndex;
	Controls::THintWindowClass FHintWndClass;
	TBlockIndexEvent FOnAfterBlockDelete;
	TBlockAllowInsertEvent FOnBeforeBlockInsertFromClipboard;
	TItemStyle FItemStyle;
	...
	void __fastcall SetItemStyle(const TItemStyle Value);
	void __fastcall SetCodeBlockCaptionSelectColor(const Graphics::TColor Value);
	void __fastcall SetCodeBlockCaptionSelectTextColor(const Graphics::TColor Value);
	
protected:
	virtual void __fastcall WndProc(Messages::TMessage &Message);
	DYNAMIC void __fastcall KeyDown(System::Word &KeyCode, Classes::TShiftState Shift);
	DYNAMIC void __fastcall KeyUp(System::Word &KeyCode, Classes::TShiftState Shift);
...
public:
	...
	void __fastcall SetItemSize(int Index, int Size);
...
__published:
	...
	__property Graphics::TColor CodeBlockCaptionSelectColor = {read=FCodeBlockCaptionSelectColor, write=SetCodeBlockCaptionSelectColor, default=536870911};
	...
	__property Graphics::TColor CodeBlockCaptionSelectTextColor = {read=FCodeBlockCaptionSelectTextColor, write=SetCodeBlockCaptionSelectTextColor, default=536870911};
	...
	__property TItemStyle ItemStyle = {read=FItemStyle, write=SetItemStyle, default=0};
	...
	__property TBlockIndexEvent OnAfterBlockDelete = {read=FOnAfterBlockDelete, write=FOnAfterBlockDelete};
	...
	__property TBlockAllowInsertEvent OnBeforeBlockInsertFromClipboard = {read=FOnBeforeBlockInsertFromClipboard, write=FOnBeforeBlockInsertFromClipboard};
