...
public:
	...
	Types::TRect __fastcall Rect(void);
...
#pragma option push -b-
enum TURLStyle { usUnderline, usNone };
#pragma option pop
...
private:
	...
	bool FShowSplitter;
	bool FMetro;
	System::UnicodeString __fastcall IsAnchor(int x, int y, System::UnicodeString &Title);
...
__published:
	...
	__property TURLStyle URLStyle = {read=FURLStyle, write=FURLStyle, default=0};
