...
typedef void __fastcall (__closure *TGetDropDownPosEvent)(System::TObject* Sender, Types::TPoint &Pos);
...
protected:
	...
	void __fastcall ResetDropSize(void);
	...
	tagSIZE __fastcall GetDropDownSize(void);
...
public:
	...
	__property tagSIZE DropDownSize = {read=GetDropDownSize};
public:
