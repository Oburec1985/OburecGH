...
class DELPHICLASS TAppColor;
class PASCALIMPLEMENTATION TAppColor : public Classes::TPersistent
{
	typedef Classes::TPersistent inherited;
...
private:
	...
	Graphics::TColor FAppButtonColor;
	Graphics::TColor FAppButtonHoverColor;
	...
	void __fastcall SetHoverBorderColor(const Graphics::TColor Value);
	void __fastcall SetSelectedBorderColor(const Graphics::TColor Value);
	...
	void __fastcall SetAppButtonColor(const Graphics::TColor Value);
	void __fastcall SetAppButtonHoverColor(const Graphics::TColor Value);
	
protected:
	virtual void __fastcall Changed(void);
	
public:
	__fastcall TAppColor(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	
__published:
	__property Graphics::TColor AppButtonColor = {read=FAppButtonColor, write=SetAppButtonColor, nodefault};
	__property Graphics::TColor AppButtonHoverColor = {read=FAppButtonHoverColor, write=SetAppButtonHoverColor, nodefault};
	...
	__property Graphics::TColor HoverTextColor = {read=FHoverTextColor, write=SetHoverTextColor, nodefault};
	__property Graphics::TColor HoverBorderColor = {read=FHoverBorderColor, write=SetHoverBorderColor, nodefault};
	...
	__property Graphics::TColor SelectedBorderColor = {read=FSelectedBorderColor, write=SetSelectedBorderColor, nodefault};
	__property Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TAppColor(void) { }
...
private:
	...
	void __fastcall SetAppColor(const TAppColor* Value);
...
protected:
	...
	__property TAppColor* AppColor = {read=FAppColor, write=SetAppColor};
	...
	TAdvToolBarPager* __fastcall GetToolBarPager(void);
...
private:
	...
	Imglist::TImageIndex FCompactImageIndex;
	int FUpdateCount;
	...
	Classes::TNotifyEvent FOnCompactShow;
	...
	void __fastcall SetCompactImageIndex(const Imglist::TImageIndex Value);
	...
	TDragGripStyle __fastcall GetDragGripStyle(void);
	void __fastcall SetDragGripStyle(const TDragGripStyle Value);
...
protected:
	...
	virtual void __fastcall DoCompactToolBarShow(void);
	...
	void __fastcall UpdateSeparators(void);
	...
	__property TToolBarState ToolBarState = {read=FToolBarState, write=FToolBarState, nodefault};
	...
	__property bool HideDragGrip = {read=FHideDragGrip, write=FHideDragGrip, default=0};
	...
	__property Imglist::TImageIndex CompactImageIndex = {read=FCompactImageIndex, write=SetCompactImageIndex, nodefault};
	__property System::UnicodeString CompactShortCutHint = {read=FCompactShortCutHint, write=FCompactShortCutHint};
	__property Classes::TNotifyEvent OnClose = {read=FOnClose, write=FOnClose};
	__property Classes::TNotifyEvent OnCompactShow = {read=FOnCompactShow, write=FOnCompactShow};
...
public:
	...
	__property TCompactWindow* CompactWindow = {read=FCompactWindow};
	...
	__property TDragGripStyle DragGripStyle = {read=GetDragGripStyle, write=SetDragGripStyle, nodefault};
...
public:
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TFloatingWindow(void) { }
...
private:
	...
	void __fastcall SetItemTextFontSize(const int Value);
...
public:
	...
	__property int ItemTextFontSize = {read=FItemTextFontSize, write=SetItemTextFontSize, nodefault};
public:
...
typedef void __fastcall (__closure *THintHelpEvent)(System::TObject* Sender, Controls::TControl* AControl);
...
private:
	System::UnicodeString FMDIMaximizeBtnHint;
	System::UnicodeString FMDIMinimizeBtnHint;
	System::UnicodeString FMDICloseBtnHint;
	Classes::TNotifyEvent FOnChange;
	System::UnicodeString FHelpBtnHint;
	void __fastcall SetHelpBtnHint(const System::UnicodeString Value);
	void __fastcall SetMDICloseBtnHint(const System::UnicodeString Value);
	void __fastcall SetMDIMaximizeBtnHint(const System::UnicodeString Value);
	void __fastcall SetMDIMinimizeBtnHint(const System::UnicodeString Value);
...
__published:
	__property System::UnicodeString MDICloseBtnHint = {read=FMDICloseBtnHint, write=SetMDICloseBtnHint};
	__property System::UnicodeString MDIMinimizeBtnHint = {read=FMDIMinimizeBtnHint, write=SetMDIMinimizeBtnHint};
	__property System::UnicodeString MDIMaximizeBtnHint = {read=FMDIMaximizeBtnHint, write=SetMDIMaximizeBtnHint};
	__property System::UnicodeString HelpBtnHint = {read=FHelpBtnHint, write=SetHelpBtnHint};
	__property Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
public:
...
public:
	Advstyleif::TColorTones Buttons;
	Advstyleif::TColorTones Tab;
	Advstyleif::TColorTones Pager;
	TAppColor* App;
};


#pragma option push -b-
enum TGroupStyle { gsClassic, gsOffice2013, gsWindows8, gsOffice2016 };
#pragma option pop
...
private:
	...
	Gdipicture::TGDIPPicture* FIOptionPicture;
	Gdipicture::TGDIPPicture* FIOptionDisabledPicture;
	Gdipicture::TGDIPPicture* FHelpButtonPicture;
	bool FAutoMDIButtons;
	bool FMDIButtonsVisible;
	...
	int FUpdateCount;
	THintHelpEvent FOnHintHelp;
	Gdipicture::TGDIPPicture* FIBrandingPicture;
	Types::TPoint FCaptionClickXY;
	int FDesignedHeight;
	bool FBlockHide;
	int FDefTabHeight;
	void __fastcall SetBrandingPicture(const Gdipicture::TGDIPPicture* Value);
	...
	void __fastcall OnOptionPictureChanged(System::TObject* Sender);
	void __fastcall OnHelpButtonPictureChanged(System::TObject* Sender);
	...
	void __fastcall SetHelpButtonPicture(const Gdipicture::TGDIPPicture* Value);
...
protected:
	...
	Advofficehint::TAdvOfficeHint* __fastcall GetOfficeHint(void);
	...
	void __fastcall UpdatePagerSize(void);
	...
	bool __fastcall DoSubclass(void);
...
public:
	...
	__property bool IsAeroVista = {read=FIsAeroVista, nodefault};
	__property bool BlockHide = {read=FBlockHide, write=FBlockHide, nodefault};
	__property int DefTabHeight = {read=FDefTabHeight, nodefault};
	void __fastcall ShapeButtonRefreshed(void);
	void __fastcall ClearOfficeTones(void);
	void __fastcall SetOfficeTones(const TOfficeTones &ATones, TGroupStyle GroupStyle);
...
__published:
	...
	__property Gdipicture::TGDIPPicture* HelpButtonPicture = {read=FHelpButtonPicture, write=SetHelpButtonPicture};
	__property Gdipicture::TGDIPPicture* OptionPicture = {read=FIOptionPicture, write=SetOptionPicture};
	__property Gdipicture::TGDIPPicture* OptionDisabledPicture = {read=FIOptionDisabledPicture, write=SetOptionDisabledPicture};
	__property Visible = {default=1};
	...
	__property Classes::TNotifyEvent OnMouseEnter = {read=FOnMouseEnter, write=FOnMouseEnter};
	__property Classes::TNotifyEvent OnMouseLeave = {read=FOnMouseLeave, write=FOnMouseLeave};
	__property THintHelpEvent OnHintHelpF1 = {read=FOnHintHelp, write=FOnHintHelp};
	__property OnKeyDown;
	__property OnKeyUp;
	__property OnKeyPress;
	...
	__property Gdipicture::TGDIPPicture* BrandingPicture = {read=FIBrandingPicture, write=SetBrandingPicture};
public:
...
public:
	/* TCustomControl.Destroy */ inline __fastcall virtual ~TCaptionLayer(void) { }
...
protected:
	...
	virtual void __fastcall Loaded(void);
	virtual bool __fastcall IsItones(void);
	void __fastcall UpdateMe(int PropID);
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation Operation);
	DYNAMIC void __fastcall MouseUp(Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	DYNAMIC void __fastcall MouseDown(Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
...
static const ShortInt DEFAULT_TABHEIGHT96DPI = 0x1a;
static const ShortInt DEFAULT_CAPTIONHEIGHT96DPI = 0x10;
static const ShortInt DEFAULT_PAGERCAPTIONHEIGHT96DPI = 0x1b;
...
extern PACKAGE int DEFAULT_PAGERCAPTIONHEIGHT;
extern PACKAGE int DEFAULT_CAPTIONHEIGHT;
extern PACKAGE bool ADVToolBarDPI_FormScaled;
extern PACKAGE float ADVToolBarDPI_Scale;
extern PACKAGE bool ADVToolBarDPI_ScaleSet;
extern PACKAGE System::Word WM_TBCOMPACTWINHIDE;
extern PACKAGE System::Word WM_TBSETAEROVISTA;
extern PACKAGE System::Word WM_TBFUPDATECONTEXTMENU;
extern PACKAGE System::Word WM_TBPSETIGNOREALT;
extern PACKAGE System::Word WM_TBSETMETRO;
extern PACKAGE System::Word WM_TBREVERTMETRO;
extern PACKAGE System::Word WM_TBSETOFFICE2013;
extern PACKAGE System::Word WM_TBSHOWSHORTCUTHINT;
extern PACKAGE bool ATF_NoDropShadow;
extern PACKAGE Advstyleif::TColorTones TBFormMetroTones;
extern PACKAGE Advstyleif::TColorTones TBFormOfficeTones;
extern PACKAGE unsigned SHORTCUT_DELAY;
extern PACKAGE bool CANCAPTURE;
extern PACKAGE float __fastcall AdvToolBar_GetDPIScale(HDC FHandle = (HDC)(0x0));
