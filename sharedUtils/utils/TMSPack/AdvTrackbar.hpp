...
protected:
	...
	virtual void __fastcall ChangeLeft(void);
...
public:
	...
	int __fastcall MouseToPosition(const int X, const int Y);
public:
...
private:
	...
	Classes::TNotifyEvent FOnChangeLeft;
	Classes::TNotifyEvent FOnChangeRight;
...
protected:
	virtual void __fastcall ChangeLeft(void);
	virtual void __fastcall ChangeRight(void);
	virtual void __fastcall Paint(void);
	DYNAMIC void __fastcall KeyDown(System::Word &Key, Classes::TShiftState Shift);
	DYNAMIC void __fastcall MouseDown(Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	DYNAMIC void __fastcall MouseMove(Classes::TShiftState Shift, int X, int Y);
...
__published:
	...
	__property OnStartDock;
	__property OnStartDrag;
	__property Classes::TNotifyEvent OnChangeLeft = {read=FOnChangeLeft, write=FOnChangeLeft};
	__property Classes::TNotifyEvent OnChangeRight = {read=FOnChangeRight, write=FOnChangeRight};
	__property OnClick;
	__property OnMouseDown;
	__property OnMouseMove;
	__property OnMouseUp;
