...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE int __stdcall StrCmpLogicalW(System::WideChar * psz1, System::WideChar * psz2);
extern PACKAGE int __fastcall Limit(int v, int mi, int ma);
extern PACKAGE System::UnicodeString __fastcall RemoveAccentedStr(System::UnicodeString s);
...
extern PACKAGE void __fastcall SplitString(System::UnicodeString sep, System::UnicodeString s, Classes::TStringList* sl);
...
extern PACKAGE TTextType __fastcall TextType(System::UnicodeString s, bool AllowHTML = true);
extern PACKAGE bool __fastcall IsNumChar(System::WideChar ch);
...
extern PACKAGE bool __fastcall CheckFloatNumNoExp(System::WideChar ch);
...
extern PACKAGE System::UnicodeString __fastcall GetLongestLine(Graphics::TCanvas* Canvas, System::UnicodeString s);
...
extern PACKAGE int __fastcall NumCharDel(System::WideChar p, System::WideChar del, System::UnicodeString s);
...
extern PACKAGE System::UnicodeString __fastcall StripCRLF(System::UnicodeString s);
...
extern PACKAGE void __fastcall DrawButton(Graphics::TCanvas* Canvas, unsigned AHandle, const Types::TRect &ARect, TControlDrawStyle AControlStyle, TControlState AState, const Advstyleif::TColorTones &ATones, bool Prefix, System::UnicodeString ACaption = L"");
