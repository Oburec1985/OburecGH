...
class PASCALIMPLEMENTATION TCalcButtonItem : public Classes::TCollectionItem
{
...
public:
	__fastcall virtual TCalcButtonItem(Classes::TCollection* Collection);
	__fastcall virtual ~TCalcButtonItem(void);
...
class PASCALIMPLEMENTATION TCalcButtonItems : public Classes::TCollection
{
	typedef Classes::TCollection inherited;
	
public:
	TCalcButtonItem* operator[](int Index) { return Items[Index]; }
	
private:
	Classes::TPersistent* FMyOwner;
	Classes::TNotifyEvent FOnChange;
	HIDESBASE TCalcButtonItem* __fastcall GetItem(int Index);
	HIDESBASE void __fastcall SetItem(int Index, const TCalcButtonItem* Value);
	
public:
	__fastcall TCalcButtonItems(Classes::TPersistent* AOwner);
	__property TCalcButtonItem* Items[int Index] = {read=GetItem, write=SetItem/*, default*/};
	HIDESBASE TCalcButtonItem* __fastcall Add(void);
	HIDESBASE TCalcButtonItem* __fastcall Insert(int Index);
	DYNAMIC Classes::TPersistent* __fastcall GetOwner(void);
	__property Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
public:
	/* TCollection.Destroy */ inline __fastcall virtual ~TCalcButtonItems(void) { }
...
private:
	...
	void __fastcall SetButtons(const TCalcButtonItems* Value);
