...
#pragma option push -b-
enum TAdvCardItemType { itLabeledItem, itItem, itLabel, itProgressBar, itHTMLText };
#pragma option pop
...
protected:
	...
	__property Picturecontainer::TPictureContainer* PictureContainer = {read=FPictureContainer};
...
typedef void __fastcall (__closure *TAdvCardItemComboEvent)(System::TObject* Sender, int CardIndex, int ItemIndex, int ComboIndex);
...
typedef void __fastcall (__closure *TAdvCardItemGetPicture)(System::TObject* Sender, int CardIndex, int ItemIndex, Graphics::TPicture* Picture);

typedef void __fastcall (__closure *TAdvCardItemAnchorClickEvent)(System::TObject* Sender, TAdvCard* Card, TAdvCardItem* Item, System::UnicodeString AAnchor, bool &DoDefault);
...
private:
	...
	bool FDblClick;
	Stdctrls::TComboBox* FEditCombo;
	Stdctrls::TMemo* FEditMemo;
	...
	TAdvCardItemComboEvent FOnCardComboSelect;
	TAdvCardCaptionGetDisplText FOnCardCaptionGetDisplText;
	TAdvCardItemGetDisplText FOnCardItemGetDisplText;
	TAdvCardItemGetPicture FOnCardItemGetPicture;
	TAdvCardItemGetDisplText FOnCardItemCaptionGetDisplText;
	...
	TAdvCardItemAnchorClickEvent FOnCardItemAnchorClick;
...
protected:
	...
	virtual void __fastcall HandleComboSelect(System::TObject* Sender);
	...
	virtual void __fastcall DoAnchorClick(TAdvCard* Card, TAdvCardItem* Item, System::UnicodeString AAnchor, bool &DoDefault);
...
public:
	...
	__property Stdctrls::TComboBox* EditCombo = {read=FEditCombo};
	__property Stdctrls::TMemo* EditMemo = {read=FEditMemo};
	...
	__property TAdvCardItemComboEvent OnCardComboSelect = {read=FOnCardComboSelect, write=FOnCardComboSelect};
	...
	__property TAdvCardItemGetDisplText OnCardItemCaptionGetDisplText = {read=FOnCardItemCaptionGetDisplText, write=FOnCardItemCaptionGetDisplText};
	__property TAdvCardItemGetPicture OnCardItemGetPicture = {read=FOnCardItemGetPicture, write=FOnCardItemGetPicture};
	__property TAdvCardItemAnchorClickEvent OnCardItemAnchorClick = {read=FOnCardItemAnchorClick, write=FOnCardItemAnchorClick};
	...
	void __fastcall StartEdit(const Types::TRect &EditRect, int CardIndex, int ItemIndex, const System::Variant &Value, System::WideChar StartChar)/* overload */;
	void __fastcall StartEdit(int CardIndex, int ItemIndex)/* overload */;
	void __fastcall CancelEditing(void);
	void __fastcall DoneEdit(const System::Variant &Value);
	void __fastcall SetDefaultAppearance(void);
