...
private:
	...
	TInspectorItemEvent FOnEditProp;
...
protected:
	...
	virtual void __fastcall DoEditStart(TInspectorPanel* APanel, TInspectorItem* AItem);
	virtual void __fastcall DoEditProp(TInspectorPanel* APanel, TInspectorItem* AItem);
...
__published:
	...
	__property TInspectorItemEvent OnEditProp = {read=FOnEditProp, write=FOnEditProp};
