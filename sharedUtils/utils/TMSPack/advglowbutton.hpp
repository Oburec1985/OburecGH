...
private:
	...
	Graphics::TColor FBorderColorCheckedHot;
	Graphics::TColor FBorderColorFocused;
	Graphics::TColor FColor;
	Graphics::TColor FColorTo;
	...
	void __fastcall SetBorderColorFocused(const Graphics::TColor Value);
...
public:
	...
	__property bool NoBorderDefault = {read=FNoBorderDefault, write=FNoBorderDefault, nodefault};
...
__published:
	...
	__property Graphics::TColor BorderColorCheckedHot = {read=FBorderColorCheckedHot, write=FBorderColorCheckedHot, default=536870911};
	...
	__property Graphics::TColor BorderColorFocused = {read=FBorderColorFocused, write=SetBorderColorFocused, default=14986633};
	...
	__property Graphics::TColor TextColorChecked = {read=FTextColorChecked, write=SetTextColorChecked, default=0};
...
private:
	...
	void __fastcall SetAlwaysShowAccel(const bool Value);
...
protected:
	...
	__property bool AlwaysShowAccel = {read=FAlwaysShowAccel, write=SetAlwaysShowAccel, default=0};
	...
	void __fastcall NotesChanged(System::TObject* Sender);
...
__published:
	...
	__property AlwaysShowAccel = {default=0};
