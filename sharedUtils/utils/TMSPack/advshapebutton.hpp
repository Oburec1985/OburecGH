...
protected:
	...
	void __fastcall SwitchOffice2013(bool Value);
	...
	__property System::Word TextOffset = {read=FTextOffset, write=FTextOffset, default=0};
...
public:
	...
	void __fastcall ShowFrame(void);
	...
	__property TAdvShapeButtonAppearance* MetroAppearance = {read=FMetroAppearance, write=FMetroAppearance};
