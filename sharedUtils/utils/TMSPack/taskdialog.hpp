...
#pragma option push -b-
enum TTaskDialogOption { doHyperlinks, doCommandLinks, doCommandLinksNoIcon, doExpandedDefault, doExpandedFooter, doAllowMinimize, doVerifyChecked, doProgressBar, doProgressBarMarquee, doTimer, doNoDefaultRadioButton, doAllowDialogCancel, doSizeToContent };
#pragma option pop

typedef Set<TTaskDialogOption, doHyperlinks, doSizeToContent>  TTaskDialogOptions;
...
#pragma option push -b-
enum TInputType { itEdit, itMemo, itComboEdit, itComboList, itDate, itCustom, itNone, itTime, itPassword };
#pragma option pop
...
typedef void __fastcall (__closure *TValidateInputTextEvent)(System::TObject* Sender, System::UnicodeString &NewValue, const int Data, const int ModalResult, bool &IsValid);
...
private:
	...
	int FInputMaxLength;
	int FInputItemIndex;
	System::TDateTime FInputDateTime;
...
protected:
	...
	__property int InputItemIndex = {read=FInputItemIndex, write=FInputItemIndex, nodefault};
	__property System::TDateTime InputDateTime = {read=FInputDateTime, write=FInputDateTime};
	...
	virtual int __fastcall ExecutePos(int X, int Y);
...
public:
	...
	__property InputItemIndex;
	__property InputDateTime;
...
protected:
	...
	virtual void __fastcall DoUpdateInput(void);
...
extern PACKAGE int __fastcall AdvMessageBox(HWND hWnd, System::WideChar * lpInstruction, System::WideChar * lpTitle, unsigned flags, bool NonNative = false);
