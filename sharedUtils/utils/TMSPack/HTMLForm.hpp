...
private:
	Classes::TNotifyEvent FOnMaskError;
...
protected:
	...
	__property Classes::TNotifyEvent OnMaskError = {read=FOnMaskError, write=FOnMaskError};
public:
...
private:
	...
	THTMLControlEvent FOnControlEditMaskError;
...
protected:
	...
	void __fastcall ControlMaskError(System::TObject* Sender);
...
__published:
	...
	__property THTMLControlEvent OnControlEditMaskError = {read=FOnControlEditMaskError, write=FOnControlEditMaskError};
