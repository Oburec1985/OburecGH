...
private:
	...
	bool __fastcall GetUACEnabled(void);
...
protected:
	...
	virtual void __fastcall DoSetAppParamBefore(System::UnicodeString &Param);
	virtual void __fastcall DoSetAppParamAfter(System::UnicodeString &Param);
...
public:
	...
	virtual void __fastcall DoRestart(void);
	...
	System::UnicodeString __fastcall WinTempDir(void);
	...
	__property bool UACEnabled = {read=GetUACEnabled, nodefault};
...
__published:
	...
	__property System::UnicodeString URL = {read=FURL, write=FURL};
	__property bool HideURLInLogFile = {read=FHideURLInLogFile, write=FHideURLInLogFile, default=0};
...
static const ShortInt WebUpdateDownloadError = 0x14;
...
static const ShortInt ErrDownloadSizeWrong = 0xa;
...
#define DXE2 L"\\Software\\Embarcadero\\BDS\\9.0"
#define DXE3 L"\\Software\\Embarcadero\\BDS\\10.0"
#define DXE4 L"\\Software\\Embarcadero\\BDS\\11.0"
#define DXE5 L"\\Software\\Embarcadero\\BDS\\12.0"
#define DXE6 L"\\Software\\Embarcadero\\BDS\\14.0"
#define DXE7 L"\\Software\\Embarcadero\\BDS\\15.0"
#define DXE8 L"\\Software\\Embarcadero\\BDS\\16.0"
