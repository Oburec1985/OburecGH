...
#pragma option push -b-
enum TDatePart { dpYear, dpMonth, dpDay, dpNone };
#pragma option pop
...
protected:
	...
	TDatePart __fastcall DatePartAtCursor(int Pos);
...
__published:
	...
	__property bool CheckMinValue = {read=FCheckMinValue, write=FCheckMinValue, default=0};
	__property bool CheckMaxValue = {read=FCheckMaxValue, write=FCheckMaxValue, default=0};
