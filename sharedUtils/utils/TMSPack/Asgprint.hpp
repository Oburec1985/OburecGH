...
private:
	...
	void __fastcall SetPrintPreviewWidth(const int Value);
...
__published:
	...
	__property bool PrintPreview = {read=FPrintPreview, write=SetPrintPreview, default=1};
	__property int PrintPreviewWidth = {read=FPrintPreviewWidth, write=SetPrintPreviewWidth, default=250};
