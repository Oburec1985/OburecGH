...
#pragma option push -b-
enum TAdvEditType { etString, etNumeric, etFloat, etUppercase, etMixedCase, etLowerCase, etPassword, etMoney, etRange, etHex, etAlphaNumeric, etValidChars, etInvalidChars };
#pragma option pop
...
typedef void __fastcall (__closure *TLookupNeedDataEvent)(System::TObject* Sender, System::UnicodeString Value, Classes::TStrings* List, int &ItemIndex);
...
#pragma option push -b-
enum TValueSeparator { vsBracket, vsSquareBracket, vsLargerSmaller, vsNone };
#pragma option pop
...
protected:
	...
	virtual void __fastcall DoLookupNeedData(System::UnicodeString Value, Classes::TStrings* List, int &ItemIndex);
...
class PASCALIMPLEMENTATION TAdvCustomMaskEdit : public Mask::TCustomMaskEdit
{
...
private:
	...
	bool FParentFnt;
	bool FGotReturn;
	Classes::TNotifyEvent FOnValidateError;
	Classes::TNotifyEvent FOnValidateEdit;
...
protected:
	...
	__property Graphics::TColor NormalColor = {read=FNormalColor, nodefault};
	
public:
	__fastcall virtual TAdvCustomMaskEdit(Classes::TComponent* AOwner);
	virtual void __fastcall SetBounds(int ALeft, int ATop, int AWidth, int AHeight);
	__fastcall virtual ~TAdvCustomMaskEdit(void);
	__property bool Modified = {read=GetModified, write=SetModified, nodefault};
	virtual void __fastcall Loaded(void);
	...
	__property Classes::TNotifyEvent OnValidateError = {read=FOnValidateError, write=FOnValidateError};
	__property Classes::TNotifyEvent OnValidateEdit = {read=FOnValidateEdit, write=FOnValidateEdit};
	__property System::UnicodeString Version = {read=GetVersion, write=SetVersion};
public:
	/* TWinControl.CreateParented */ inline __fastcall TAdvCustomMaskEdit(HWND ParentWindow) : Mask::TCustomMaskEdit(ParentWindow) { }
...
__published:
	...
	__property OnStartDrag;
public:
	/* TAdvCustomMaskEdit.Create */ inline __fastcall virtual TAdvMaskEdit(Classes::TComponent* AOwner) : TAdvCustomMaskEdit(AOwner) { }
	/* TAdvCustomMaskEdit.Destroy */ inline __fastcall virtual ~TAdvMaskEdit(void) { }
...
extern PACKAGE TAutoType __fastcall IsStringType(System::UnicodeString s);
