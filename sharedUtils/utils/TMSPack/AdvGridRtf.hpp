...
typedef void __fastcall (__closure *TRTFRenderGridEvent)(System::TObject* Sender, Rtfengine::TRTFEngine* RTFEngine);
...
private:
	...
	System::UnicodeString FFontBuffer;
	System::UnicodeString FColorBuffer;
	TRTFRenderGridEvent FOnRenderTitle;
	TRTFRenderGridEvent FOnRenderFooter;
...
protected:
	...
	virtual void __fastcall DoRenderTitle(Rtfengine::TRTFEngine* RTFEngine);
	virtual void __fastcall DoRenderFooter(Rtfengine::TRTFEngine* RTFEngine);
...
public:
	...
	void __fastcall ExportBufferToRTF(const Sysutils::TFileName FileName);
...
__published:
	...
	__property TRTFRenderGridEvent OnRenderTitle = {read=FOnRenderTitle, write=FOnRenderTitle};
	__property TRTFRenderGridEvent OnRenderFooter = {read=FOnRenderFooter, write=FOnRenderFooter};
