...
class DELPHICLASS TAdvOfficeComboBoxActionLink;
class PASCALIMPLEMENTATION TAdvOfficeComboBoxActionLink : public Controls::TControlActionLink
{
	typedef Controls::TControlActionLink inherited;
	
protected:
	TAdvCustomOfficeComboBox* FClient;
	virtual void __fastcall AssignClient(System::TObject* AClient);
	
public:
	virtual void __fastcall UpdateText(System::UnicodeString AValue);
public:
	/* TBasicActionLink.Create */ inline __fastcall virtual TAdvOfficeComboBoxActionLink(System::TObject* AClient) : Controls::TControlActionLink(AClient) { }
	/* TBasicActionLink.Destroy */ inline __fastcall virtual ~TAdvOfficeComboBoxActionLink(void) { }
...
protected:
	...
	void __fastcall DropWindowHide(System::TObject* Sender);
...
__published:
	...
	__property bool EnableMouseWheel = {read=FEnableMouseWheel, write=FEnableMouseWheel, default=1};
...
private:
	...
	TFontSizeDigits FFontSizeDigits;
...
__published:
	...
	__property TFontSizeDigits FontSizeDigits = {read=FFontSizeDigits, write=FFontSizeDigits, default=0};
	__property ImeMode = {default=3};
	__property ImeName;
	__property ParentBiDiMode = {default=1};
	__property ParentColor = {default=0};
...
extern PACKAGE Types::TRect __fastcall DrawVistaText(Graphics::TCanvas* Canvas, Classes::TAlignment Alignment, const Types::TRect &r, const System::UnicodeString Caption, Graphics::TFont* AFont, bool Enabled, bool RealDraw, Advgdip::TAntiAlias AntiAlias, Comctrls::TTabPosition Direction);
extern PACKAGE void __fastcall DrawVistaGradient(Graphics::TCanvas* Canvas, const Types::TRect &r, Graphics::TColor CFU, Graphics::TColor CTU, Graphics::TColor CFB, Graphics::TColor CTB, Graphics::TColor PC, Advglowbutton::TGDIPGradient GradientU, Advglowbutton::TGDIPGradient GradientB, const System::UnicodeString Caption, Graphics::TFont* AFont, Controls::TImageList* Images, int ImageIndex, bool EnabledImage, Advglowbutton::TButtonLayout Layout, bool DropDownButton, bool DrawDwLine, bool Enabled, bool Focus, Advglowbutton::TDropDownPosition DropDownPos, Gdipicture::TGDIPPicture* Picture, Advgdip::TAntiAlias AntiAlias, bool RoundEdges, bool RotateLeftRight, Comctrls::TTabPosition Direction)/* overload */;
extern PACKAGE void __fastcall DrawVistaGradient(Graphics::TCanvas* Canvas, const Types::TRect &r, Graphics::TColor CFU, Graphics::TColor CTU, Graphics::TColor CFB, Graphics::TColor CTB, Graphics::TColor PC, Advglowbutton::TGDIPGradient GradientU, Advglowbutton::TGDIPGradient GradientB, const System::UnicodeString Caption, Graphics::TFont* AFont, bool Enabled, bool Focus, Advgdip::TAntiAlias AntiAlias, bool RoundEdges, bool RotateLeftRight, Comctrls::TTabPosition Direction = (Comctrls::TTabPosition)(0x0))/* overload */;
