...
extern PACKAGE void __fastcall DrawProgress(Graphics::TCanvas* Canvas, const Types::TRect &r, Graphics::TColor Color1, Graphics::TColor FontColor1, Graphics::TColor Color2, Graphics::TColor FontColor2, int Pos, System::UnicodeString ValueFormat, bool ShowValue = true);
