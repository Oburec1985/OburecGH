...
public:
	...
	int __fastcall ColumnHas(int col, System::UnicodeString s);
...
private:
	...
	bool FDropUpdate;
	int FEditHeight;
	System::UnicodeString FUnSelectedText;
	int FWinProc;
	...
	HIDESBASE void __fastcall UpdateLabelPos(void);
	...
	void __fastcall SetUnSelectedText(const System::UnicodeString Value);
	HIDESBASE void __fastcall SetEmptyText(const System::UnicodeString Value);
	HIDESBASE void __fastcall SetEmptyTextStyle(const Graphics::TFontStyles Value);
...
protected:
	...
	void __fastcall DoParentFontChange(void);
	__property int WinProc = {read=FWinProc, write=FWinProc, nodefault};
...
public:
	...
	__property System::UnicodeString UnSelectedText = {read=FUnSelectedText, write=SetUnSelectedText};
