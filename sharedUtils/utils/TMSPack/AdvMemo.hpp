...
#pragma option push -b-
enum TStyleType { stKeyword, stBracket, stSymbol, stComment };
#pragma option pop

#pragma option push -b-
enum TAdvMemoStyle { msOffice2003Blue, msOffice2003Olive, msOffice2003Silver, msOffice2003Classic, msOffice2007Luna, msOffice2007Obsidian, msWindowsXP, msWhidbey, msCustom, msOffice2007Silver, msWindowsVista, msWindows7, msTerminal, msOffice2010Blue, msOffice2010Silver, msOffice2010Black, msWindows8, msOffice2013White, msOffice2013LightGray, msOffice2013Gray, msWindows10, msOffice2016White, msOffice2016Gray, msOffice2016Black };
#pragma option pop
...
typedef void __fastcall (__closure *TWordIsURLEvent)(System::TObject* Sender, System::UnicodeString AToken, bool &IsUrl);
...
private:
	...
	System::WideChar FHintClassDelimiter;
...
__published:
	...
	__property System::WideChar HintClassDelimiter = {read=FHintClassDelimiter, write=FHintClassDelimiter, nodefault};
...
public:
	...
	inline void __fastcall  SaveToStream(Classes::TStream* Stream, Sysutils::TEncoding* Encoding){ Classes::TStrings::SaveToStream(Stream, Encoding); }
...
public:
	...
	virtual void __fastcall PerformRedo(void);
public:
	/* TUndo.Create */ inline __fastcall TNewLineUndo(int ACurX0, int ACurY0, int ACurX, int ACurY, System::UnicodeString AText) : TUndo(ACurX0, ACurY0, ACurX, ACurY, AText) { }
...
class DELPHICLASS TModifiedUndo;
class PASCALIMPLEMENTATION TModifiedUndo : public TUndo
{
	typedef TUndo inherited;
...
public:
	virtual void __fastcall PerformUndo(void);
	virtual void __fastcall PerformRedo(void);
	__property int LineIndex = {read=FLineIndex, write=FLineIndex, nodefault};
public:
	/* TUndo.Create */ inline __fastcall TModifiedUndo(int ACurX0, int ACurY0, int ACurX, int ACurY, System::UnicodeString AText) : TUndo(ACurX0, ACurY0, ACurX, ACurY, AText) { }
	
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TModifiedUndo(void) { }
...
public:
	__fastcall TIndentUndo(int ACurX, int ACurY, int SelFrom, int SelTo, int Indent);
	virtual void __fastcall PerformUndo(void);
	virtual void __fastcall PerformRedo(void);
...
typedef void __fastcall (__closure *TGutterHintEvent)(System::TObject* Sender, int Line, System::UnicodeString &AHint, bool &Show);
...
typedef void __fastcall (__closure *TMemoGetCompletionListIndexEvent)(System::TObject* Sender, System::UnicodeString AToken, Classes::TStringList* AList, int &AIndex);
...
typedef void __fastcall (__closure *TMemoRetrievedParameterHintEvent)(System::TObject* Sender, System::UnicodeString AToken, System::UnicodeString AParameterHint);

#pragma option push -b-
enum TDrawMode { dmScreen, dmHTML, dmPrinter, dmPrintPreview, dmRTF, dmParts };
#pragma option pop
...
typedef void __fastcall (__closure *TCodeFoldEvent)(System::TObject* Sender, int LineNo, bool Expanded);
...
private:
	...
	bool FKeepLastSize;
	int FMaxWidth;
	System::UnicodeString FStartToken;
	bool FFromFirstChar;
...
__published:
	...
	__property System::UnicodeString StartToken = {read=FStartToken, write=FStartToken};
...
class DELPHICLASS TMemoPartItem;
class PASCALIMPLEMENTATION TMemoPartItem : public Classes::TCollectionItem
{
	typedef Classes::TCollectionItem inherited;
...
private:
	...
	System::UnicodeString FText;
	bool FURL;
	Graphics::TColor FBkgColor;
	Graphics::TFontStyles FFontStyle;
	
public:
	__fastcall virtual TMemoPartItem(Classes::TCollection* Collection);
	__property Graphics::TColor Color = {read=FColor, write=FColor, nodefault};
	__property Graphics::TColor BkgColor = {read=FBkgColor, write=FBkgColor, nodefault};
	__property System::UnicodeString Text = {read=FText, write=FText};
	__property bool URL = {read=FURL, write=FURL, nodefault};
	__property Graphics::TFontStyles FontStyle = {read=FFontStyle, write=FFontStyle, nodefault};
public:
	/* TCollectionItem.Destroy */ inline __fastcall virtual ~TMemoPartItem(void) { }
	
};


class DELPHICLASS TMemoParts;
class PASCALIMPLEMENTATION TMemoParts : public Classes::TCollection
{
	typedef Classes::TCollection inherited;
	
public:
	TMemoPartItem* operator[](int Index) { return Items[Index]; }
	
private:
	HIDESBASE TMemoPartItem* __fastcall GetItem(int Index);
	HIDESBASE void __fastcall SetItem(int Index, const TMemoPartItem* Value);
	
public:
	__fastcall TMemoParts(void);
	HIDESBASE TMemoPartItem* __fastcall Add(void);
	HIDESBASE TMemoPartItem* __fastcall Insert(int Index);
	__property TMemoPartItem* Items[int Index] = {read=GetItem, write=SetItem/*, default*/};
public:
	/* TCollection.Destroy */ inline __fastcall virtual ~TMemoParts(void) { }
	
};


class DELPHICLASS TMemoLineItem;
class PASCALIMPLEMENTATION TMemoLineItem : public Classes::TCollectionItem
{
	typedef Classes::TCollectionItem inherited;
...
public:
	__fastcall virtual TMemoLineItem(Classes::TCollection* Collection);
	__fastcall virtual ~TMemoLineItem(void);
	__property TMemoParts* Parts = {read=FParts};
};


class DELPHICLASS TMemoLines;
class PASCALIMPLEMENTATION TMemoLines : public Classes::TCollection
{
	typedef Classes::TCollection inherited;
	
public:
	TMemoLineItem* operator[](int Index) { return Items[Index]; }
	
private:
	HIDESBASE TMemoLineItem* __fastcall GetItem(int Index);
	HIDESBASE void __fastcall SetItem(int Index, const TMemoLineItem* Value);
	
public:
	__fastcall TMemoLines(void);
	HIDESBASE TMemoLineItem* __fastcall Add(void);
	HIDESBASE TMemoLineItem* __fastcall Insert(int Index);
	__property TMemoLineItem* Items[int Index] = {read=GetItem, write=SetItem/*, default*/};
public:
	/* TCollection.Destroy */ inline __fastcall virtual ~TMemoLines(void) { }
...
public:
	__property TAdvCustomMemo* Memo = {read=FMemo, write=FMemo};
	Types::TPoint __fastcall CurrentWordPos(int X, int Y);
...
private:
	System::UnicodeString FScrollHint;
	System::UnicodeString FCut;
	System::UnicodeString FPaste;
	System::UnicodeString FSelectAll;
	System::UnicodeString FUndo;
	System::UnicodeString FRedo;
	System::UnicodeString FCopy;
	System::UnicodeString FDelete;
...
__published:
	__property System::UnicodeString ScrollHint = {read=FScrollHint, write=FScrollHint};
	__property System::UnicodeString Undo = {read=FUndo, write=FUndo};
	__property System::UnicodeString Redo = {read=FRedo, write=FRedo};
	__property System::UnicodeString Copy = {read=FCopy, write=FCopy};
	__property System::UnicodeString Cut = {read=FCut, write=FCut};
	__property System::UnicodeString Paste = {read=FPaste, write=FPaste};
	__property System::UnicodeString Delete = {read=FDelete, write=FDelete};
	__property System::UnicodeString SelectAll = {read=FSelectAll, write=FSelectAll};
public:
...
#pragma option push -b-
enum TOleDropTargetType { odtFile, odtText };
#pragma option pop

typedef Set<TOleDropTargetType, odtFile, odtText>  TOleDropTarget;
...
typedef void __fastcall (__closure *TOleDropTextEvent)(System::TObject* Sender, int X, int Y, System::UnicodeString &Text, bool &Allow);

typedef void __fastcall (__closure *TOleDropFileEvent)(System::TObject* Sender, int X, int Y, System::UnicodeString FileName, bool &Allow);

typedef void __fastcall (__closure *TOleTextDraggedEvent)(System::TObject* Sender, System::UnicodeString Text, bool CopyText);
...
private:
	...
	bool FIsDragSource;
	bool FOleDropSource;
	TOleDropTarget FOleDropTarget;
	bool FOleDropTargetAssigned;
	Classes::TNotifyEvent FOnChange;
	Classes::TNotifyEvent FOnSave;
	Classes::TNotifyEvent FOnHideAutoComplete;
	...
	TOleDropTextEvent FOnOleDropText;
	TOleDropFileEvent FOnOleDropFile;
	TOleTextDraggedEvent FOnOleTextDragged;
	bool FAutoExpand;
	...
	bool FHighLightCaseSensitive;
	bool FUseVCLStyles;
	Menus::TPopupMenu* FStdMenu;
	TMemoLines* FMemoLines;
	...
	void __fastcall ListKeyDown(System::TObject* Sender, System::Word &Key, Classes::TShiftState ShiftState);
	...
	System::UnicodeString __fastcall TrimRightWW(int LineNo, bool Undo);
	...
	MESSAGE void __fastcall WMPrepareShowHint(Messages::TMessage &Msg);
	...
	void __fastcall DrawParts(System::UnicodeString Part, TStyle &Drawstyle, int lineno);
	...
	void __fastcall CheckCodeInsightChar(System::WideChar Key);
	void __fastcall SetBandColor(const Graphics::TColor Value);
	System::UnicodeString __fastcall GetVersion(void);
	System::UnicodeString __fastcall ApplyCS(System::UnicodeString s);
	int __fastcall NearestStart(System::UnicodeString s, int fromX, System::UnicodeString &res, int &ParNum);
	void __fastcall SetUILanguage(const TUILanguage* AUILanguage);
	void __fastcall SetSelectionMode(const TSelectionMode Value);
	void __fastcall SetHighLightText(const System::UnicodeString Value);
	...
	void __fastcall AddBmpRes(System::UnicodeString Resname, Controls::TImageList* ImageList);
	void __fastcall SetVersion(const System::UnicodeString Value);
	int __fastcall GetBookmarkCount(void);
	void __fastcall SetOleDropTarget(const TOleDropTarget Value);
	void __fastcall SetHighlightCaseSensitive(const bool Value);
	
protected:
	bool FLetRefresh;
	bool FLetCursorUpdate;
	void __fastcall PrepareShowHint(void);
	virtual void __fastcall UpdateCompletionList(System::UnicodeString token);
	virtual bool __fastcall IsCompletionListActivationChar(System::WideChar Ch);
	virtual bool __fastcall HasCompletionListActivationChar(System::UnicodeString token);
	virtual bool __fastcall IsParameterHintActivationChar(System::WideChar Ch);
	virtual bool __fastcall IsCompletionListSearchChar(System::WideChar Ch);
	virtual bool __fastcall IsCompletionListEndChar(System::WideChar Ch);
	virtual void __fastcall DoLineBkColor(int LineNo, Graphics::TColor &BkColor);
	virtual void __fastcall DoOleDropText(int X, int Y, System::UnicodeString &Text);
	virtual void __fastcall DoOleDropFile(int X, int Y, System::UnicodeString FileName);
	virtual void __fastcall DoOleTextDragged(System::UnicodeString Text, bool CopyText);
	...
	virtual void __fastcall DoIsURL(System::UnicodeString AToken, bool &IsURL);
	virtual void __fastcall WndProc(Messages::TMessage &Message);
	...
	virtual System::UnicodeString __fastcall LineBreak(void);
	...
	int __fastcall FindTextInt(System::UnicodeString SearchStr, Dialogs::TFindOptions Options, bool Count)/* overload */;
	int __fastcall FindTextInt(System::UnicodeString SearchStr, TFindOptionsEx Options, bool Count)/* overload */;
	...
	virtual void __fastcall DoGetAutoCompletionListIndex(System::UnicodeString AToken, Classes::TStringList* AList, int &DefaultIndex);
	virtual void __fastcall DoGetParameterHint(System::UnicodeString AToken, System::UnicodeString &AParameterHint, bool &Handled);
	virtual void __fastcall DoGetParameterHintInfo(System::UnicodeString &AToken, int &AParIndex, bool &Found, bool &Handled);
	virtual void __fastcall DoInsertAutoCompletionEntry(System::UnicodeString &AEntry);
	...
	__property int TabSize = {read=FTabSize, write=FTabSize, default=4};
	...
	__property TCodeFoldEvent OnCodeFold = {read=FOnCodeFold, write=FOnCodeFold};
	...
	__property Classes::TNotifyEvent OnHideAutoComplete = {read=FOnHideAutoComplete, write=FOnHideAutoComplete};
	...
	__property TWordIsURLEvent OnIsURL = {read=FOnIsURL, write=FOnIsURL};
	...
	__property TOleDropTextEvent OnOleDropText = {read=FOnOleDropText, write=FOnOleDropText};
	__property TOleDropFileEvent OnOleDropFile = {read=FOnOleDropFile, write=FOnOleDropFile};
	__property TOleTextDraggedEvent OnOleTextDragged = {read=FOnOleTextDragged, write=FOnOleTextDragged};
	...
	System::UnicodeString __fastcall NextToken(const System::UnicodeString s, int StartFrom, int &Offset);
	void __fastcall GetLines(void);
...
public:
	...
	__property System::UnicodeString HighlightText = {read=FHighlightText, write=SetHighLightText};
	__property bool HighlightCaseSensitive = {read=FHighLightCaseSensitive, write=SetHighlightCaseSensitive, nodefault};
	__property TAdvMemoStrings* Lines = {read=FLines, write=SetLines};
	...
	__property System::UnicodeString URLDelimiters = {read=FUrlDelimiters, write=FUrlDelimiters};
	void __fastcall SelectWordAtCursor(void);
	System::UnicodeString __fastcall TokenAtCursor(void);
	...
	bool __fastcall HasMarkers(void);
	int __fastcall FindTextCount(System::UnicodeString SearchStr, Dialogs::TFindOptions Options)/* overload */;
	int __fastcall FindTextCount(System::UnicodeString SearchStr, TFindOptionsEx Options)/* overload */;
	int __fastcall FindText(System::UnicodeString SearchStr, Dialogs::TFindOptions Options)/* overload */;
	int __fastcall FindText(System::UnicodeString SearchStr, TFindOptionsEx Options)/* overload */;
	int __fastcall FindTextInMemo(System::UnicodeString SearchStr, Dialogs::TFindOptions Options)/* overload */;
	...
	int __fastcall FindAndReplace(System::UnicodeString SearchStr, System::UnicodeString NewStr, Dialogs::TFindOptions Options)/* overload */;
	int __fastcall FindAndReplace(System::UnicodeString SearchStr, System::UnicodeString NewStr, TFindOptionsEx Options)/* overload */;
	...
	void __fastcall ScrollToBottom(void);
	...
	__property TOleDropTarget OleDropTarget = {read=FOleDropTarget, write=SetOleDropTarget, nodefault};
	...
	__property TMemoLines* MemoLines = {read=FMemoLines};
...
private:
	...
	System::UnicodeString FStrictNumericChars;
	...
	System::UnicodeString FEscapeChar;
...
protected:
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation Operation);
	virtual void __fastcall Loaded(void);
	int __fastcall PosCommentLeft(System::UnicodeString s, int &cl, int &ci, int &ct);
	int __fastcall PosCommentRight(System::UnicodeString s, int &cl, int &ci, int &ct);
	bool __fastcall HasMultiComment(void);
	bool __fastcall HasCommentStyles(void);
...
public:
	...
	__property System::UnicodeString EscapeChar = {read=FEscapeChar, write=FEscapeChar};
...
__published:
	...
	__property OnOleDropFile;
	__property OnOleTextDragged;
...
private:
	...
	System::UnicodeString FCommentLeft;
	System::UnicodeString FCommentRight;
...
__published:
	__property System::UnicodeString CommentLeft = {read=FCommentLeft, write=FCommentLeft};
	__property System::UnicodeString CommentRight = {read=FCommentRight, write=FCommentRight};
	...
	__property System::WideChar BracketStart = {read=FBracketStart, write=SetBracketStart, nodefault};
	__property System::WideChar BracketEnd = {read=FBracketEnd, write=SetBracketEnd, nodefault};
...
protected:
	...
	void __fastcall FindChange(System::TObject* Sender, System::UnicodeString &AText);
...
#define DATE_VER L"Oct, 2015"
static const Word WM_PREPARESHOWHINT = 0x401;
extern PACKAGE int ADVMEMO_lpcreate;
extern PACKAGE void __fastcall DecZ(int &i);
