...
typedef void __fastcall (__closure *TSectionHeightEvent)(System::TObject* Sender, int SectionIndex, int &Height);
...
public:
	...
	TSectionListBox* __fastcall ListBox(void);
...
private:
	...
	int FOldScrollPos;
	TSectionHeightEvent FOnSectionHeight;
...
protected:
	...
	virtual int __fastcall GetCustomSectionHeight(int SectionIndex);
...
__published:
	...
	__property TSectionHeightEvent OnSectionHeight = {read=FOnSectionHeight, write=FOnSectionHeight};
