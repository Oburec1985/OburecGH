...
typedef void __fastcall (__closure *TRangeSelectEvent)(System::TObject* Sender, System::TDateTime StartDate, System::TDateTime EndDate);
...
#pragma option push -b-
enum TPlannerCalendarStyle { psWindowsXP, psOffice2000, psOffice2003Blue, psOffice2003Olive, psOffice2003Silver, psOffice2003Classic, psFlat, psAvantGarde, psWhidbey, psOffice2007Luna, psOffice2007Obsidian, psCustom, psOffice2007Silver, psWindowsVista, psWindows7, psTerminal, psOffice2010Blue, psOffice2010Silver, psOffice2010Black, psWindows8, psOffice2013White, psOffice2013LightGray, psOffice2013Gray, psWindows10, psOffice2016White, psOffice2016Gray, psOffice2016Black };
#pragma option pop
...
private:
	...
	void __fastcall SetEventFont(const Graphics::TFont* Value);
...
__published:
	...
	__property Graphics::TFont* EventFont = {read=FEventFont, write=SetEventFont};
...
typedef void __fastcall (__closure *TClickDayEvent)(System::TObject* Sender, System::TDateTime ADate, Classes::TShiftState Shift);
...
private:
	...
	bool FReadOnly;
	bool FIsGrouped;
	TRangeSelectEvent FOnRangeSelect;
	TClickDayEvent FOnClickDay;
...
protected:
	...
	virtual void __fastcall DoRangeSelect(System::TDateTime StartDate, System::TDateTime EndDate);
	...
	__property bool IsGrouped = {read=FIsGrouped, write=FIsGrouped, nodefault};
	__property TClickDayEvent OnClickDay = {read=FOnClickDay, write=FOnClickDay};
...
__published:
	...
	__property TRangeSelectEvent OnRangeSelect = {read=FOnRangeSelect, write=FOnRangeSelect};
...
private:
	...
	bool FEnable;
	bool FReadOnly;
	System::TDateTime FClickStart;
	System::TDateTime FClickEnd;
	HIDESBASE MESSAGE void __fastcall CMFontChanged(Messages::TMessage &Message);
	...
	void __fastcall ClickDay(System::TObject* Sender, System::TDateTime ADate, Classes::TShiftState Shift);
