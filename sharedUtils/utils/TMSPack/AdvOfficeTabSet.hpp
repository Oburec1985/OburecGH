...
public:
	...
	__property System::TObject* TabObject = {read=FObject, write=FObject};
...
private:
	typedef DynamicArray<Types::TPoint> _TAdvCustomOfficeTabSet__1;
...
private:
	...
	bool FMultiLine;
	_TAdvCustomOfficeTabSet__1 FTabRows;
...
public:
	...
	void __fastcall AddTab(System::UnicodeString Caption);
	...
	TOfficeTabCollectionItem* __fastcall TabByName(System::UnicodeString Value);
	TOfficeTabCollectionItem* __fastcall TabByCaption(System::UnicodeString Value);
