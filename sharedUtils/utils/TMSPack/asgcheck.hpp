...
private:
	...
	Controls::TModalResult FLastResult;
...
public:
	__fastcall virtual TAdvStringGridCheck(Classes::TComponent* AOwner);
	...
	__property Classes::TComponent* Grid = {read=FGrid, write=FGrid};
	__property Controls::TModalResult LastResult = {read=FLastResult, write=FLastResult, nodefault};
...
public:
	virtual System::UnicodeString __fastcall Correct(int ACol, int ARow, System::UnicodeString s);
public:
	/* TAdvStringGridCheck.Create */ inline __fastcall virtual TCapitalCheck(Classes::TComponent* AOwner) : TAdvStringGridCheck(AOwner) { }
