...
// (DO NOT EDIT: machine generated header) 'Jclopendialogfavorites.pas' rev: 21.00
...
public:
	...
	__fastcall virtual ~TJclOpenDialogFavoritesHook(void);
	void __fastcall LoadFavorites(const System::UnicodeString FileName);
...
//-- end unit ----------------------------------------------------------------
#endif	// JclopendialogfavoritesHPP
