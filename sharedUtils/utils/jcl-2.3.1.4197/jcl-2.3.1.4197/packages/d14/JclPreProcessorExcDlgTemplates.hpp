...
// (DO NOT EDIT: machine generated header) 'Jclpreprocessorexcdlgtemplates.pas' rev: 21.00
...
private:
	...
	System::UnicodeString FFormAncestor;
	bool FModalDialog;
	...
	System::UnicodeString __fastcall GetIgnoredException(void);
...
__published:
	...
	__property System::UnicodeString FormAncestor = {read=FFormAncestor, write=FFormAncestor};
	...
	__property System::UnicodeString IgnoredException = {read=GetIgnoredException};
...
//-- end unit ----------------------------------------------------------------
#endif	// JclpreprocessorexcdlgtemplatesHPP
