...
// (DO NOT EDIT: machine generated header) 'Jclunitversioningproviders.pas' rev: 21.00
...
extern PACKAGE bool __fastcall InsertUnitVersioningSection(const Sysutils::TFileName ExecutableFileName, TJclUnitVersioningList* AUnitList);
...
//-- end unit ----------------------------------------------------------------
#endif	// JclunitversioningprovidersHPP
