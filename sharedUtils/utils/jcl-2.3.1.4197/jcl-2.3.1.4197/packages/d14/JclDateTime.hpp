...
// (DO NOT EDIT: machine generated header) 'Jcldatetime.pas' rev: 21.00
...
public:
	/* Exception.Create */ inline __fastcall EJclDateTimeError(const System::UnicodeString Msg) : Jclbase::EJclError(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EJclDateTimeError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : Jclbase::EJclError(Msg, Args, Args_Size) { }
	...
	/* Exception.CreateHelp */ inline __fastcall EJclDateTimeError(const System::UnicodeString Msg, int AHelpContext) : Jclbase::EJclError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EJclDateTimeError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : Jclbase::EJclError(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EJclDateTimeError(void) { }
...
extern PACKAGE System::TDateTime __fastcall EncodeDate(const int Year, System::Word Month, System::Word Day)/* overload */;
extern PACKAGE void __fastcall DecodeDate(System::TDateTime Date, /* out */ System::Word &Year, /* out */ System::Word &Month, /* out */ System::Word &Day)/* overload */;
extern PACKAGE void __fastcall DecodeDate(System::TDateTime Date, /* out */ int &Year, /* out */ int &Month, /* out */ int &Day)/* overload */;
extern PACKAGE void __fastcall DecodeDate(System::TDateTime Date, /* out */ int &Year, /* out */ System::Word &Month, /* out */ System::Word &Day)/* overload */;
...
extern PACKAGE System::Word __fastcall ISODayOfWeek(const System::TDateTime DateTime);
extern PACKAGE bool __fastcall IsISOLongYear(const System::TDateTime DateTime)/* overload */;
extern PACKAGE bool __fastcall IsISOLongYear(const System::Word Year)/* overload */;
extern PACKAGE System::Word __fastcall GetISOYearNumberOfWeeks(const System::Word Year);
...
extern PACKAGE void __fastcall DosDateTimeToFileTime(System::Word DTH, System::Word DTL, const _FILETIME &FT)/* overload */;
extern PACKAGE int __fastcall FileTimeToDosDateTime(const _FILETIME &FileTime)/* overload */;
extern PACKAGE void __fastcall FileTimeToDosDateTime(const _FILETIME &FileTime, /* out */ System::Word &Date, /* out */ System::Word &Time)/* overload */;
extern PACKAGE System::UnicodeString __fastcall FileTimeToStr(const _FILETIME &FileTime);
extern PACKAGE System::UnicodeString __fastcall DosDateTimeToStr(int DateTime);
extern PACKAGE System::UnicodeString __fastcall SystemTimeToStr(const _SYSTEMTIME &SystemTime);
...
extern PACKAGE System::UnicodeString __fastcall FormatDateTime(System::UnicodeString Form, System::TDateTime DateTime);
...
extern PACKAGE Sysutils::TTimeStamp __fastcall NullStamp(void);
