...
// (DO NOT EDIT: machine generated header) 'Mscoree_tlb.pas' rev: 21.00
...
public:
	...
	StaticArray<unsigned, 3> GenCollectionsTaken;
...
__interface  INTERFACE_UUID("{178E5337-1528-4591-B1C9-1C6E484686D8}") IApartmentCallback  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{C3FCC19E-A970-11D2-8B5A-00A0C9B7C9C4}") IManagedObject  : public System::IInterface 
{
	
public:
	virtual HRESULT __stdcall GetSerializedBuffer(/* out */ System::WideString &pBSTR) = 0 ;
	virtual HRESULT __stdcall GetObjectIdentity(/* out */ System::WideString &pBSTRGUID, /* out */ int &AppDomainID, /* out */ int &pCCW) = 0 ;
};

__interface ICatalogServices;
typedef System::DelphiInterface<ICatalogServices> _di_ICatalogServices;
__interface  INTERFACE_UUID("{04C6BE1E-1DB1-4058-AB7A-700CCCFBF254}") ICatalogServices  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{00000003-0000-0000-C000-000000000046}") IMarshal  : public System::IInterface 
{
...
public:
	...
	virtual HRESULT __stdcall RemoteRead(/* out */ System::Byte &pv, unsigned cb, /* out */ unsigned &pcbRead) = 0 ;
	virtual HRESULT __stdcall Write(void * &pv, unsigned cb, /* out */ unsigned &pcbWritten) = 0 ;
	virtual HRESULT __stdcall RemoteWrite(System::Byte &pv, unsigned cb, /* out */ unsigned &pcbWritten) = 0 ;
};

__interface ICorConfiguration;
typedef System::DelphiInterface<ICorConfiguration> _di_ICorConfiguration;
__interface  INTERFACE_UUID("{CB2F6722-AB3A-11D2-9C40-00C04FA30A3E}") ICorRuntimeHost  : public System::IInterface 
{
...
public:
	...
	virtual HRESULT __stdcall CreateDomain(System::WideChar * pwzFriendlyName, const System::_di_IInterface pIdentityArray, /* out */ System::_di_IInterface &pAppDomain) = 0 ;
	...
	virtual HRESULT __stdcall CreateDomainEx(System::WideChar * pwzFriendlyName, const System::_di_IInterface pSetup, const System::_di_IInterface pEvidence, /* out */ System::_di_IInterface &pAppDomain) = 0 ;
...
__interface  INTERFACE_UUID("{FAC34F6E-0DCD-47B5-8021-531BC5ECCA63}") IGCHost  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{5C2B07A5-1E98-11D3-872F-00C04F79ED0D}") ICorConfiguration  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{F31D1788-C397-4725-87A5-6AF3472C2791}") IGCThreadControl  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{5513D564-8374-4CB9-AED9-0083F4160A1D}") IGCHostControl  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{23D86786-0BB5-4774-8FB5-E3522ADD6246}") IDebuggerThreadControl  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{63DF8730-DC81-4062-84A2-1FF943F59FAC}") IValidator  : public System::IInterface 
{
	
public:
	virtual HRESULT __stdcall Validate(const _di_IVEHandler veh, const System::_di_IInterface pAppDomain, unsigned ulFlags, unsigned ulMaxError, unsigned Token, System::WideChar * fileName, System::Byte &pe, unsigned ulSize) = 0 ;
	virtual HRESULT __stdcall FormatEventInfo(HRESULT hVECode, const tag_VerError Context, System::WideChar * msg, unsigned ulMaxLength, Activex::PSafeArray psa) = 0 ;
};

__interface IDebuggerInfo;
typedef System::DelphiInterface<IDebuggerInfo> _di_IDebuggerInfo;
__interface  INTERFACE_UUID("{BF24142D-A47D-4D24-A66D-8C2141944E44}") IDebuggerInfo  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{856CA1B2-7DAB-11D3-ACEC-00C04F86C309}") IVEHandler  : public System::IInterface 
{
...
public:
	__classmethod _di_IMarshal __fastcall Create();
	__classmethod _di_IMarshal __fastcall CreateRemote(const System::UnicodeString MachineName);
public:
...
public:
	__classmethod _di_ICorRuntimeHost __fastcall Create();
	__classmethod _di_ICorRuntimeHost __fastcall CreateRemote(const System::UnicodeString MachineName);
public:
