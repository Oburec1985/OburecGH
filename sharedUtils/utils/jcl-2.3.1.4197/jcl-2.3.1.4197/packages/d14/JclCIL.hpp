...
// (DO NOT EDIT: machine generated header) 'Jclcil.pas' rev: 21.00
...
private:
	TJclOpCode FOpCode;
	unsigned FOffset;
	System::Variant FParam;
	TJclClrILGenerator* FOwner;
	bool __fastcall GetWideOpCode(void);
	System::Byte __fastcall GetRealOpCode(void);
	...
	System::UnicodeString __fastcall FormatLabel(int Offset);
	
protected:
	virtual unsigned __fastcall GetSize(void);
	virtual System::UnicodeString __fastcall DumpILOption(TJclInstructionDumpILOption Option);
...
public:
	...
	System::UnicodeString __fastcall DumpIL(TJclInstructionDumpILOptions Options = (TJclInstructionDumpILOptions() << doIL ));
	...
	__property System::Byte RealOpCode = {read=GetRealOpCode, nodefault};
	__property System::Variant Param = {read=FParam, write=FParam};
...
public:
	...
	System::UnicodeString __fastcall DumpIL(TJclInstructionDumpILOptions Options);
	__property Jclmetadata::TJclClrMethodBody* Method = {read=FMethod};
	__property TJclInstruction* Instructions[const int Idx] = {read=GetInstruction};
...
public:
	/* Exception.Create */ inline __fastcall EJclCliInstructionError(const System::UnicodeString Msg) : Jclbase::EJclError(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EJclCliInstructionError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : Jclbase::EJclError(Msg, Args, Args_Size) { }
	...
	/* Exception.CreateHelp */ inline __fastcall EJclCliInstructionError(const System::UnicodeString Msg, int AHelpContext) : Jclbase::EJclError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EJclCliInstructionError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : Jclbase::EJclError(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EJclCliInstructionError(void) { }
...
public:
	/* Exception.Create */ inline __fastcall EJclCliInstructionStreamInvalid(const System::UnicodeString Msg) : EJclCliInstructionError(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EJclCliInstructionStreamInvalid(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : EJclCliInstructionError(Msg, Args, Args_Size) { }
	...
	/* Exception.CreateHelp */ inline __fastcall EJclCliInstructionStreamInvalid(const System::UnicodeString Msg, int AHelpContext) : EJclCliInstructionError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EJclCliInstructionStreamInvalid(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : EJclCliInstructionError(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EJclCliInstructionStreamInvalid(void) { }
	
};


//-- var, const, procedure ---------------------------------------------------
#define InstructionDumpILAllOption (Set<TJclInstructionDumpILOption, doLineNo, doComment> () << doLineNo << doRawBytes << doIL << doTokenValue << doComment )
