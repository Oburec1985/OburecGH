...
// (DO NOT EDIT: machine generated header) 'Jclwin32ex.pas' rev: 21.00
...
extern PACKAGE unsigned __fastcall JclOpenWaitableTimer(unsigned dwDesiredAccess, bool bInheritHandle, const System::UnicodeString lpTimerName);
...
extern PACKAGE bool __fastcall JclGetFileAttributesEx(const System::UnicodeString lpFileName, _GET_FILEEX_INFO_LEVELS fInfoLevelId, void * lpFileInformation);
extern PACKAGE unsigned __fastcall JclCreateWaitableTimer(Windows::PSecurityAttributes lpTimerAttributes, bool bManualReset, const System::AnsiString lpTimerName);
extern PACKAGE bool __fastcall JclCancelWaitableTimer(unsigned hTimer);
extern PACKAGE System::WideChar * __fastcall JclglGetString(unsigned name);
...
extern PACKAGE System::WideChar * __fastcall JclgluErrorString(unsigned errCode);
