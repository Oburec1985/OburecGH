...
// (DO NOT EDIT: machine generated header) 'Jclschedule.pas' rev: 21.00
...
public:
	/* Exception.Create */ inline __fastcall EJclScheduleError(const System::UnicodeString Msg) : Jclbase::EJclError(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EJclScheduleError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : Jclbase::EJclError(Msg, Args, Args_Size) { }
	...
	/* Exception.CreateHelp */ inline __fastcall EJclScheduleError(const System::UnicodeString Msg, int AHelpContext) : Jclbase::EJclError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EJclScheduleError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : Jclbase::EJclError(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EJclScheduleError(void) { }
...
__interface  INTERFACE_UUID("{1CC54450-7F84-4F27-B1C1-418C451DAD80}") IJclSchedule  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{6CF37F0D-56F4-4AE6-BBCA-7B9DFE60F50D}") IJclScheduleDayFrequency  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{540E22C5-BE14-4539-AFB3-E24A67C58D8A}") IJclDailySchedule  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{73F15D99-C6A1-4526-8DE3-A2110E099BBC}") IJclWeeklySchedule  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{705E17FC-83E6-4385-8D2D-17013052E9B3}") IJclMonthlySchedule  : public System::IInterface 
{
...
__interface  INTERFACE_UUID("{3E5303B0-FFA0-495A-96BB-14A718A01C1B}") IJclYearlySchedule  : public System::IInterface 
{
...
extern PACKAGE _di_IJclSchedule __fastcall CreateSchedule(void);
