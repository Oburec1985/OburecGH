...
// (DO NOT EDIT: machine generated header) 'Jclhookexcept.pas' rev: 21.00
...
{
//-- type declarations -------------------------------------------------------
typedef Sysutils::Exception* __fastcall (*TJclExceptFilterProc)(Sysutils::PExceptionRecord ExceptRecord);
...
extern PACKAGE bool __fastcall JclAddExceptFilter(const TJclExceptFilterProc FilterProc, TJclExceptNotifyPriority Priority = (TJclExceptNotifyPriority)(0x0));
...
extern PACKAGE bool __fastcall JclRemoveExceptFilter(const TJclExceptFilterProc FilterProc);
...
extern PACKAGE bool __fastcall JclUnhookExceptionsInModule(unsigned Module);
