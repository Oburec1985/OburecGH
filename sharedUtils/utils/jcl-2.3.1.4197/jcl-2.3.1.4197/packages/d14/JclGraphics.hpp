...
// (DO NOT EDIT: machine generated header) 'Jclgraphics.pas' rev: 21.00
...
public:
	/* Exception.Create */ inline __fastcall EJclGraphicsError(const System::UnicodeString Msg) : Jclbase::EJclError(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EJclGraphicsError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : Jclbase::EJclError(Msg, Args, Args_Size) { }
	...
	/* Exception.CreateHelp */ inline __fastcall EJclGraphicsError(const System::UnicodeString Msg, int AHelpContext) : Jclbase::EJclError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EJclGraphicsError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : Jclbase::EJclError(Msg, Args, Args_Size, AHelpContext) { }
	...
	/* Exception.Destroy */ inline __fastcall virtual ~EJclGraphicsError(void) { }
...
public:
	StaticArray<StaticArray<System::Extended, 3>, 3> A;
};
...
typedef StaticArray<System::Byte, 256> TGamma;
...
private:
	void *FData;
	int FDataSize;
	Types::TRect __fastcall GetBox(void);
...
public:
	...
	__fastcall TJclRegion(const int Top, const int Left, const int Bottom, const int Right, System::Byte DummyForBCB)/* overload */;
	...
	HIDESBASE bool __fastcall Equals(TJclRegion* CompareRegion);
...
private:
	...
	#pragma pack(pop)
	Jclgraphutils::TColor32Array *FBits;
	TDrawMode FDrawMode;
	Graphics::TFont* FFont;
	HBITMAP FHandle;
	HDC FHDC;
	System::Byte FMasterAlpha;
	Jclgraphutils::TColor32 FOuterColor;
	Jclgraphutils::TColor32 FPenColor;
	float FStippleCounter;
	Jclgraphutils::TArrayOfColor32 FStipplePattern;
	float FStippleStep;
	...
	void __fastcall SetMasterAlpha(System::Byte Value);
...
protected:
	...
	__classmethod bool __fastcall ClipLineF(float &X0, float &Y0, float &X1, float &Y1, float MinX, float MaxX, float MinY, float MaxY);
...
public:
	...
	void __fastcall TextOut(const Types::TRect &ClipRect, const unsigned Flags, const System::UnicodeString Text)/* overload */;
	...
	void __fastcall RenderText(int X, int Y, const System::UnicodeString Text, int AALevel, Jclgraphutils::TColor32 Color);
...
__published:
	...
	__property System::Byte MasterAlpha = {read=FMasterAlpha, write=SetMasterAlpha, default=255};
...
public:
	...
	void __fastcall Rotate(System::Extended Cx, System::Extended Cy, System::Extended Alpha);
	void __fastcall Skew(System::Extended Fx, System::Extended Fy);
	void __fastcall Scale(System::Extended Sx, System::Extended Sy);
	void __fastcall Translate(System::Extended Dx, System::Extended Dy);
...
extern PACKAGE void __fastcall JPegToBitmap(const System::UnicodeString FileName);
extern PACKAGE void __fastcall BitmapToJPeg(const System::UnicodeString FileName);
extern PACKAGE void __fastcall GifToBitmap(const System::UnicodeString FileName);
extern PACKAGE void __fastcall BitmapToGif(const System::UnicodeString FileName);
extern PACKAGE void __fastcall PngToBitmap(const System::UnicodeString FileName);
extern PACKAGE void __fastcall BitmapToPng(const System::UnicodeString FileName);
extern PACKAGE int __fastcall ExtractIconCount(const System::UnicodeString FileName);
...
extern PACKAGE void __fastcall SaveIconToFile(HICON Icon, const System::UnicodeString FileName);
...
extern PACKAGE HRGN __fastcall CreateRegionFromBitmap(Graphics::TBitmap* Bitmap, Graphics::TColor RegionColor, TJclRegionBitmapMode RegionBitmapMode, bool UseAlphaChannel = false);
...
extern PACKAGE void __fastcall ScreenShot(Graphics::TBitmap* bm, Controls::TWinControl* ControlToPrint)/* overload */;
extern PACKAGE void __fastcall ScreenShot(Graphics::TBitmap* bm, System::UnicodeString ControlToPrint)/* overload */;
extern PACKAGE void __fastcall ScreenShot(Graphics::TBitmap* bm, Forms::TCustomForm* FormToPrint, Controls::TWinControl* ControlToPrint)/* overload */;
extern PACKAGE void __fastcall ScreenShot(Graphics::TBitmap* bm, Forms::TCustomForm* FormToPrint)/* overload */;
extern PACKAGE void __fastcall ScreenShot(Graphics::TBitmap* bm, Forms::TCustomForm* FormToPrint, System::UnicodeString ControlToPrint)/* overload */;
...
extern PACKAGE void __fastcall ApplyLUT(TJclBitmap32* Dst, TJclBitmap32* Src, System::Byte const *LUT);
