...
type
  ...
  private
    ...
    /// <summary> ˜˜˜˜˜˜˜˜˜ ˜˜˜˜˜˜˜˜˜˜˜˜˜ ˜˜˜˜˜˜˜˜ OpenGL 2D ˜˜˜ ˜˜˜˜˜˜ ˜˜˜˜˜˜˜ ˜˜˜˜˜˜. </summary>

    procedure Apply2DView;
    /// <summary> ˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜ ˜˜˜˜˜ ˜˜˜˜˜˜˜˜˜ ˜˜˜˜˜ ˜˜˜˜˜˜˜˜˜ ˜ OpenGL (ABGR -> RGBA). </summary>
    ...
    /// <summary> ˜˜˜˜˜˜˜˜˜˜˜˜˜˜ ˜˜˜˜˜˜˜˜˜ ˜˜˜˜˜ ˜˜˜˜˜ Immediate Mode OpenGL. </summary>
...
begin
  ...
  begin
    ...
    try
      ...
      if lMaxW > 0 then
        lTextWidth := Round(lMaxW) + 12; // 6px ˜˜˜˜˜, 6px ˜˜˜˜˜˜
    finally
      lRawLines.Free;
    end;
  end;
  ...
  if SelectedObject = ALabel then
    ...
    SetGLColor(TChartFlagLabel(ALabel).Trend.Color) // ˜ ˜˜˜˜ ˜˜˜˜˜˜˜˜˜˜˜˜˜˜˜ ˜˜˜˜˜
  else
    SetGLColor($FFCCCCCC); // ˜˜˜˜˜˜˜ ˜˜˜˜˜
  glLineWidth(1.0);
  DrawRect(lLabelRect);
  ...
  begin
    lOldColor := lFont.Color;
    if (ALabel is TChartFlagLabel) and (TChartFlagLabel(ALabel).Trend <> nil) then
      lFont.Color := TChartFlagLabel(ALabel).Trend.Color // ˜˜˜˜˜ ˜˜˜˜˜˜ ˜˜˜˜˜
    else
