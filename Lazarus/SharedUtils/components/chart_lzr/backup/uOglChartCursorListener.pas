...
function TChartCursorListener.GetSnappedX(ATrend: cBaseTrend; AMouseWorldX, AMouseWorldY, ADeltaXWorld: Double): Double;
var
  lLine: cLineSeries;
  lBuff: cBuffTrend1d;
  I: Integer;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          lMouseWorldXPlus5 := lRenderer.PixelToXValue(fActivePage, nil, X + 5, lContentRect.Left, lContentRect.Right);
          ...
          lTrend := lRenderer.FindSelectedTrend(fActivePage, lRenderer.SelectedObject);
          lSnappedX := GetSnappedX(lTrend, lMouseWorldX, lMouseWorldY, lDeltaXWorld);
    ...
    begin
      ...
      begin
        ...
        begin
          if (TControl(ASender).Cursor = crSizeWE) or (TControl(ASender).Cursor = crSizeNS) then
