...
begin
  ...
  lGroup := AddGroup(Self, lLeftPanel, 8, 8, 210, 58, 'Отображение');
  ...
  lGroup := AddGroup(Self, lLeftPanel, 238, 8, 390, 58, 'Сигналы');
  ...
  lGroup := AddGroup(Self, lLeftPanel, 8, 166, 620, 284, 'Запись');
