unit uRecorderMic140Stream;

{ ╨з╤В╨╡╨╜╨╕╨╡ ╨║╨░╨┤╤А╨╛╨▓ ╤Б╨║╨░╨╜╨░: num_buff, corrupt, ╨┤╨╡╨║╨╛╨╝╨╝╤Г╤В╨░╤Ж╨╕╤П AIn. }
...
uses
  SysUtils,
  uRecorderDeviceInterfaces, uRecorderMic140WireTypes,
  uRecorderMic140Protocol, uRecorderMic140Consts, uRecorderMic140Diag;
