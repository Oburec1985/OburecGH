...
- **Решение:**
  - В [uRecorderMic140DataSource.pas](file:///d:/works/OburecGH/Lazarus/RecorderLnx/Core/uRecorderMic140DataSource.pas) функции `ParseMic140ChannelNumber` и `SameMic140Address` объявлены в секции `interface` для возможности внешнего тестирования и повторного использования.
...
- **Решение:**
  - В [uRecorderMic140DataSource.pas](file:///d:/works/OburecGH/Lazarus/RecorderLnx/Core/uRecorderMic140DataSource.pas) добавлен параметр `AUpdateTimeMs` в конструктор `TRecorderMic140Device` и сохраняется в поле `fUpdateTimeMs`.
