...
| `TIMER_PERIOD`      | 640            | Период аппаратного таймера кадра в часах супервизора 114 модуля (50 кГц, 20 мкс шаг) |
| `PERIOD_AD`         | 5 µs           | Шаг оцифровки ΣΔ-АЦП (`period_aver` в UI)                                            |
| `PERIOD_TIMER_WORK` | 112 тиков кода | Накладные расходы прерываний таймера в часах 20 мкс (UTS и другие служебные функции) |
