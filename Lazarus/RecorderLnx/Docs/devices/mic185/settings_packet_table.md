...
С 2026-09-02 поле «Канал термокомпенсации» в диалоге канала связано с этим
массивом полностью: группы каналов 1..16, 17..32, 33..48 и 49..64 имеют
независимые значения. В каждой группе можно выбрать вход-компенсатор 1..4 или
«выкл»; изменение из свойств любого канала относится ко всей его группе из 16
каналов, как в оригинальном MIC185V2.
