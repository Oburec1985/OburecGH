...
begin
  ...
  begin
    ...
    begin
      ScheduleRecorderMic185SettingsSelfTest(Self, fRunSettings, fTagRegistry,
...
begin
  Result := (fDataSourceManager <> nil) and fDataSourceManager.Running;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      if fDataSourceManager.Running and
        (not RecorderHardwareIsSourceLinkOk(lSourceId)) then
...
begin
  try
    if fStateMachine.State = rsRecord then
    begin
      fStateMachine.Stop;
...
begin
  ...
  begin
    if ApplyRecorderMic185SourceDialog(Self, fTagRegistry, ATag.SourceId,
      lNewSourceId) then
