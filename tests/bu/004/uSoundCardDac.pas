...
begin
  ...
  begin
    ...
    // callback автоматически сделает unprepare
    waveOutReset(FDeviceHandle);
...
begin
  ...
  begin
    ...
    raise Exception.CreateFmt('Error writing to waveOut device: %d, FQueuedBuffers=%d, dwFlags=%d',
      [ResultCode, FQueuedBuffers, Block.Header.dwFlags]);
  end;
